...
import{X as V,A as ut,t as m,Y as Ae,Z as ne,_ as re,$ as K,a0 as gt,a1 as ft,a2 as pt}from"./chunk-vendor.js";import{F as mt,g as T,i as we}from"./chunk-git.js";import{S as wt,s as yt,m as vt,L as Z,j as Ne,h as Me,c as Re,a as bt,y as Ct,x as St,b as kt,d as Et,e as Fe,C as G,k as U,E as M,H as xt,f as he,D as x,V as L,R as A,g as q,W as _e,i as ue,l as De,n as Tt,o as Pt,p as $t,q as It,r as Lt,t as At,u as Nt,v as Mt,w as Rt,z as Ft,A as _t,B as Dt,F as Ot,G as Gt,I as Bt,J as Oe,K as Ut,M as qt,N as Ht,O as jt,P as zt,Q as Wt,T as Vt,U as Kt,X as Jt,Y as Yt}from"./chunk-codemirror.js";import{c as B}from"./chunk-gpt-tokenizer.js";import{e as O}from"./chunk-eruda.js";(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const s of document.querySelectorAll('link[rel="modulepreload"]'))n(s);new MutationObserver(s=>{for(const i of s)if(i.type==="childList")for(const o of i.addedNodes)o.tagName==="LINK"&&o.rel==="modulepreload"&&n(o)}).observe(document,{childList:!0,subtree:!0});function t(s){const i={};return s.integrity&&(i.integrity=s.integrity),s.referrerPolicy&&(i.referrerPolicy=s.referrerPolicy),s.crossOrigin==="use-credentials"?i.credentials="include":s.crossOrigin==="anonymous"?i.credentials="omit":i.credentials="same-origin",i}function n(s){if(s.ep)return;s.ep=!0;const i=t(s);fetch(s.href,i)}})();var Ge=!1;try{var se={};Object.defineProperty(se,"passive",{get(){return Ge=!0,!1}}),window.addEventListener("testpassive",null,se),window.removeEventListener("testpassive",null,se)}catch{}if(Ge){var Xt=EventTarget.prototype.addEventListener;EventTarget.prototype.addEventListener=function(a,e,t){var n=t&&typeof t=="object",s=n?t.capture:t,i=n?Object.assign({},t):{};return i.passive===void 0&&(a==="touchstart"||a==="touchmove"||a==="wheel")&&(i.passive=!0),i.capture===void 0&&(i.capture=!!s),Xt.call(this,a,e,i)}}class ye{constructor({targetSelector:e,items:t,containerItems:n=[],itemSelector:s,dataAttribute:i}){if(this.targetSelector=e,this.items=t,this.containerItems=n,this.itemSelector=s,i){const o=i.replace("data-","");this.dataAttributeKey=o.replace(/-([a-z])/g,r=>r[1].toUpperCase())}else this.dataAttributeKey=null;this.menuElement=null,this.longPressTimeout=null,this.boundHideMenu=this.hideMenu.bind(this),this.init()}init(){this.createMenuElement(),document.addEventListener("contextmenu",this.handleContextMenu.bind(this)),document.addEventListener("touchstart",this.handleTouchStart.bind(this),{passive:!1}),document.addEventListener("touchend",this.handleTouchEnd.bind(this)),document.addEventListener("touchcancel",this.handleTouchEnd.bind(this))}createMenuElement(){this.menuElement=document.createElement("div"),this.menuElement.className="context-menu",document.body.appendChild(this.menuElement)}handleContextMenu(e){const t=e.target.closest(this.targetSelector);if(!t)return;e.preventDefault();const n=this.itemSelector?e.target.closest(this.itemSelector):null;n?this.showMenu(e.clientX,e.clientY,this.items,n):this.showMenu(e.clientX,e.clientY,this.containerItems,t)}handleTouchStart(e){const t=e.target.closest(this.targetSelector);t&&(this.longPressTimeout=setTimeout(()=>{e.preventDefault();const n=this.itemSelector?e.target.closest(this.itemSelector):null,s=n?this.items:this.containerItems;this.showMenu(e.touches[0].clientX,e.touches[0].clientY,s,n||t),this.longPressTimeout=null},500))}handleTouchEnd(){this.longPressTimeout&&(clearTimeout(this.longPressTimeout),this.longPressTimeout=null)}showMenu(e,t,n,s){this.menuElement.innerHTML="",this.menuElement.style.display="block";const i=this.dataAttributeKey&&s.dataset[this.dataAttributeKey]?s.dataset[this.dataAttributeKey]:null;n.forEach(d=>{if(d.type==="separator"){const f=document.createElement("div");f.className="context-menu-separator",this.menuElement.appendChild(f);return}const g=document.createElement("button");g.className="context-menu-item",g.textContent=d.label,g.addEventListener("click",()=>{d.action(i),this.hideMenu()}),this.menuElement.appendChild(g)});const o=this.menuElement.offsetWidth,r=this.menuElement.offsetHeight,{innerWidth:c,innerHeight:l}=window;let h=e,u=t;e+o>c&&(h=c-o-5),t+r>l&&(u=l-r-5),this.menuElement.style.top=`${u}px`,this.menuElement.style.left=`${h}px`,document.addEventListener("click",this.boundHideMenu),document.addEventListener("contextmenu",this.boundHideMenu)}hideMenu(e){e&&this.menuElement.contains(e.target)||this.menuElement.style.display==="block"&&(this.menuElement.style.display="none",document.removeEventListener("click",this.boundHideMenu),document.removeEventListener("contextmenu",this.boundHideMenu))}}class b{constructor({title:e="Notice"}={}){this.overlay=document.createElement("div"),this.overlay.className="modal-overlay hidden",this.container=document.createElement("div"),this.container.className="modal-container",this.header=document.createElement("div"),this.header.className="modal-header",this.header.textContent=e,this.content=document.createElement("div"),this.content.className="modal-content",this.content.innerHTML="Loading...",this.footer=document.createElement("div"),this.footer.className="modal-footer",this.footer.style.display="none",this.container.appendChild(this.header),this.container.appendChild(this.content),this.container.appendChild(this.footer),this.overlay.appendChild(this.container),document.body.appendChild(this.overlay)}show(){this.overlay.classList.remove("hidden")}hide(){this.overlay.classList.add("hidden")}destroy(){this.overlay.parentNode&&this.overlay.remove()}updateContent(e){this.content.innerHTML=e}addFooterButton(e,t){this.footer.style.display="flex";const n=document.createElement("button");return n.textContent=e,n.addEventListener("click",t),this.footer.appendChild(n),n}clearFooter(){this.footer.innerHTML="",this.footer.style.display="none"}static prompt({title:e,label:t,defaultValue:n=""}){return new Promise(s=>{const i=new b({title:e}),o=`modal-input-${Date.now()}`,r=`
      ...
      `;i.updateContent(r);const c=i.content.querySelector(`#${o}`),l=()=>{s(c.value),i.destroy()},h=()=>{s(null),i.destroy()};c.addEventListener("keydown",u=>{u.key==="Enter"?(u.preventDefault(),l()):u.key==="Escape"&&h()}),i.addFooterButton("OK",l),i.addFooterButton("Cancel",h),i.show(),c.focus(),c.select()})}static confirm({title:e,message:t,okText:n="OK",cancelText:s="Cancel",destructive:i=!1}){return new Promise(o=>{const r=new b({title:e});r.updateContent(`<p>${t}</p>`);const c=()=>{o(!0),r.destroy()},l=()=>{o(!1),r.destroy()},h=r.addFooterButton(n,c);i&&h.classList.add("destructive"),r.addFooterButton(s,l),r.show()})}static choice({title:e,message:t,choices:n}){return new Promise(s=>{const i=new b({title:e});i.updateContent(t),n.forEach(r=>{const c=i.addFooterButton(r.text,()=>{s(r.id),i.destroy()});r.class&&c.classList.add(r.class)});const o=r=>{r.key==="Escape"&&(s(null),i.destroy(),document.removeEventListener("keydown",o))};document.addEventListener("keydown",o),i.show()})}static selection({title:e,peerData:t,okText:n="Request"}){return new Promise(s=>{if(t.size===0){const l=new b({title:"No Peers Found"});l.updateContent("<p>There are no other peers currently connected to this sync session.</p>"),l.addFooterButton("OK",()=>{l.destroy(),s(null)}),l.show();return}const i=new b({title:e});let o='<div class="peer-selection-container">';t.forEach((l,h)=>{o+=`
        ...
        `},c=Array.from(t.values());let l='<div class="modal-send-container">';l+=r("Gardens to Send",n),l+=r("Peers to Receive",c,!0),l+="</div>",o.updateContent(l),o.content.querySelectorAll(".modal-selection-group").forEach(d=>{d.querySelector(".select-all-btn").onclick=()=>d.querySelectorAll(".modal-select-checkbox").forEach(g=>g.checked=!0),d.querySelector(".select-none-btn").onclick=()=>d.querySelectorAll(".modal-select-checkbox").forEach(g=>g.checked=!1)});const h=()=>{const d=Array.from(o.content.querySelectorAll("#group-GardenstoSend .modal-select-checkbox:checked")).map(f=>f.value),g=Array.from(o.content.querySelectorAll("#group-PeerstoReceive .modal-select-checkbox:checked")).map(f=>f.value);d.length>0&&g.length>0?i({gardens:d,peers:g}):i(null),o.destroy()},u=()=>{i(null),o.destroy()};o.addFooterButton(s,h),o.addFooterButton("Cancel",u),o.show()})}}function Zt(a){const e={};a.sort((t,n)=>t.path.localeCompare(n.path));for(const{path:t,isDirectory:n}of a){const s=t.substring(1).split("/");let i=e;for(let o=0;o<s.length;o++){const r=s[o];o===s.length-1?i[r]||(i[r]=n?{type:"folder",path:t,children:{}}:{type:"file",path:t}):(i[r]||(i[r]={type:"folder",path:"/"+s.slice(0,o+1).join("/"),children:{}}),i[r].children||(i[r].children={}),i=i[r].children)}}return e}function Be(a,e,t,n,s){const i=Object.keys(a).sort((r,c)=>{const l=a[r],h=a[c];return l.type==="folder"&&h.type!=="folder"?-1:l.type!=="folder"&&h.type==="folder"?1:r.localeCompare(c,void 0,{numeric:!0})});let o="";for(const r of i){const c=a[r],l=`padding-left: ${s*20}px;`;if(c.type==="folder"){const h=n.has(c.path);o+=`
...
# Options: 'vim', 'default'
editingMode: 'default'`,ge=`# Thoughtform.Garden Keymap Settings
#
...
- key: "Alt-z"
  run: "settings/keymaps/toggle-maximize-pane.js"`,en=`// This is the primary action script for the "Mod-Enter" keyboard shortcut.
...
});`,tn=`// This script is the action for the "Mod-Shift-Enter" keyboard shortcut.
// It is context-aware:
...
})();`,nn=`// This script toggles the visibility of the main sidebar.
window.thoughtform.ui.toggleSidebar?.();`,sn=`// This script toggles the visibility of the Eruda devtools panel.
window.thoughtform.ui.toggleDevtools?.();`,on=`// This script opens the command palette in "searchFiles" mode.
window.thoughtform.commandPalette.open('searchFiles');`,rn=`// This script opens the command palette in "executeCommand" mode for running commands.
window.thoughtform.commandPalette.open('executeCommand');`,an=`// This script opens the command palette in "searchContent" mode.
window.thoughtform.commandPalette.open('searchContent');`,cn=`// This script navigates back in the browser's history.
window.history.back();`,ln=`// This script navigates forward in the browser's history.
window.history.forward();`,dn=`// This script duplicates the currently active file in the editor.
...
}`,hn=`// This script duplicates the currently active garden.
...
}`,un=`// This script renames the currently active file in the editor.
// It will trigger a modal to ask for the new file name.
...
}`,gn=`// This script creates a new file by calling the editor's core functionality.
...
}`,fn=`// This script creates a new garden by calling the sidebar's core functionality.
...
}`,pn=`// This script runs automatically whenever a new file is created.
//
...
console.log('Created file:', event.path);`,mn=`// This script runs automatically when the application finishes loading.
//
// The 'event' variable is available in this script's scope.
// For 'app:load', it is null.

console.log('HOOK::', window.location.origin + '/Settings#settings/hooks/load.js');`,wn=`// This script runs automatically whenever a file or folder is deleted.
//
// The 'event' variable is available in this script's scope
// and contains data about the event that triggered the hook.
...
console.log('Deleted item:', event.path, 'isDirectory:', event.isDirectory);`,yn=`// This script splits the currently active pane vertically.
...
}`,vn=`// This script splits the currently active pane horizontally.

const workspace = window.thoughtform.workspace;
if (workspace && workspace.activePaneId) {
  workspace.splitPane(workspace.activePaneId, 'horizontal');
}`,bn=`// This script changes focus to the next available pane.
window.thoughtform.workspace.selectNextPane();`,Cn=`// This script changes focus to the previous available pane.
window.thoughtform.workspace.selectPrevPane();`,Sn=`// This script swaps the active pane with its previous sibling.
window.thoughtform.workspace.movePaneUp();`,kn=`// This script swaps the active pane with its next sibling.
window.thoughtform.workspace.movePaneDown();`,En=`// This script closes the currently active pane.
window.thoughtform.workspace.closeActivePane();`,xn=`// This script toggles the maximization state of the currently active pane.
window.thoughtform.workspace.toggleMaximizePane();`,Tn=`// This is a test script for the query parameter autoloader.
...
# YOUR ASSESSMENT (CONTINUE or FINISH)`,He=`You are a Deep Research Analyst. Your role is to synthesize a final, comprehensive, and multi-faceted answer based on the extensive research you have conducted.
...
`)[0],i=n.oid.substring(0,7),o=n.commit.author.name,r=new Date(n.commit.author.timestamp*1e3).toLocaleString(),c=n.commit.parent[0]||"";return`
    ...
    `,this.tabsContainer.querySelectorAll(".sidebar-tab").forEach(e=>{e.addEventListener("click",t=>{const n=t.target.dataset.tab,s=this.activeTab;if(this.activeTab=n,sessionStorage.setItem("sidebarActiveTab",this.activeTab),s==="Git"&&n!=="Git"){const i=this.editor.getFilePath(window.location.hash);this.editor.loadFile(i)}this.refresh()})})}async refresh(){this.tabsContainer.querySelectorAll(".sidebar-tab").forEach(n=>{n.classList.toggle("active",n.dataset.tab===this.activeTab)}),this.contentContainer.className="sidebar-content",this.contentContainer.classList.add(`${this.activeTab.toLowerCase()}-view`);const e=await this.gitClient.getStatuses();this.activeTab==="Files"?await this.renderFiles(e):this.activeTab==="Gardens"?await this.renderGardens():this.activeTab==="Git"&&await this.renderGitView();const t=e.some(([,n,s])=>n!==s);this.tabsContainer.querySelector('[data-tab="Git"]').classList.toggle("dirty",t)}async listAllPaths(e,t){const n=e.pfs;let s=[];try{const i=await n.readdir(t);for(const o of i){if(o===".git")continue;const r=`${t==="/"?"":t}/${o}`;try{const c=await n.stat(r);if(s.push({path:r,isDirectory:c.isDirectory()}),c.isDirectory()){const l=await this.listAllPaths(e,r);s=s.concat(l)}}catch{console.warn(`Could not stat ${r}, skipping.`)}}}catch{console.log(`Directory not found: ${t}. No items to list.`)}return s}}function Dn(a){const e=document.createElement("div");e.id="drag-overlay",e.innerHTML="<p>Drop files or folders to add them to the garden</p>",document.body.appendChild(e);const t=document.querySelector("main");if(!t){console.error("[DragDrop] Main container not found. Drag and drop to editor panes will not be handled correctly.");return}const n=o=>{e.innerHTML=`<p>${o}</p>`,e.classList.add("visible")},s=()=>{e.classList.remove("visible")},i=async(o,r,c)=>{let l=o;if(o.some(w=>w.isDirectory&&w.name===".git")){const w=await b.choice({title:".git Directory Detected",message:"<p>The content you dropped contains a .git repository. This could unintentionally overwrite your garden's history.</p><p>How would you like to proceed?</p>",choices:[{id:"import_safe",text:"Import Files (Ignore .git folder)"},{id:"cancel",text:"Cancel Import",class:"destructive"}]});if(!w||w==="cancel"){r("Import cancelled by user.","Import cancelled by user.");return}l=o.filter(S=>!(S.isDirectory&&S.name===".git")),r("Ignoring .git directory and proceeding with import.","Ignoring .git directory.")}const u=[],d=[],g=["png","jpg","jpeg","gif","svg","webp","avif","mp4","webm","mov","ogg","mp3","wav","flac","pdf","doc","docx","xls","xlsx","ppt","pptx"],f=async(w,S)=>{if(w.isFile){const E=await new Promise(I=>w.file(I)),$=`${S}/${E.name}`;E.name.toLowerCase().endsWith(".zip")?d.push(E):u.push({file:E,path:$})}else if(w.isDirectory){const E=w.createReader(),$=await new Promise(I=>E.readEntries(I));for(const I of $)await f(I,`${S}/${w.name}`)}};r("Scanning dropped items...","Scanning dropped items...");for(const w of l)await f(w,"");const p=`Found ${u.length} file(s) and ${d.length} zip archive(s) to process.`;r(p,p);const y=u.map(async({file:w,path:S})=>{let E;const $=w.name.split(".").pop()?.toLowerCase();return g.includes($)?E=await w.arrayBuffer():E=await w.text(),c.writeFile(S,E)});if((await Promise.allSettled(y)).forEach((w,S)=>{const E=u[S].path;if(w.status==="rejected"){const $=`<span style="color: var(--color-text-destructive);">ERROR:</span> Failed to write "${E}": ${w.reason}`,I=`ERROR: Failed to write "${E}": ${w.reason}`;r($,I)}else{const $=`<span style="color: var(--color-text-success);">OK:</span> Imported "${E}"`,I=`OK: Imported "${E}"`;r($,I)}}),d.length>0){const w="Note: Zip archives must be imported via the DevTools > Data panel.";r(w,w)}};t.addEventListener("dragover",o=>{o.preventDefault()}),t.addEventListener("drop",o=>{o.preventDefault()}),window.addEventListener("dragenter",o=>{o.preventDefault(),o.dataTransfer.types.includes("Files")&&n("Drop files or folders to add them to the garden")}),window.addEventListener("dragover",o=>{o.preventDefault()}),window.addEventListener("dragleave",o=>{o.clientX===0&&o.clientY===0&&s()}),window.addEventListener("drop",async o=>{o.preventDefault(),s();const r=o.dataTransfer.items;if(!r||r.length===0)return;const c=Array.from(r).map(l=>l.webkitGetAsEntry()).filter(Boolean);if(c.length>0){const l=await window.thoughtform.workspace.getActiveGitClient();if(!l){console.error("[DragDrop] Could not determine active garden. Aborting import.");const f=new b({title:"Import Error"});f.updateContent("<p>Could not determine the active garden. Please click inside an editor pane and try again.</p>"),f.addFooterButton("Close",()=>f.destroy()),f.show();return}const h=new b({title:`Importing to "${l.gardenName}"...`}),u=document.createElement("div");u.style.fontFamily="monospace",u.style.maxHeight="300px",u.style.overflowY="auto",u.style.fontSize="12px",h.updateContent(""),h.content.appendChild(u),h.show();let d="";const g=(f,p)=>{console.log(`[Import Log] ${p}`),d+=`<div>${f}</div>`,u.innerHTML=d,u.scrollTop=u.scrollHeight};try{await i(c,g,l),g("<strong>Import process complete.</strong>","Import process complete.")}catch(f){const p=`<strong style="color: var(--color-text-destructive);">A critical error occurred: ${f.message}</strong>`,y=`A critical error occurred: ${f.message}`;g(p,y),console.error("[DragDrop] A critical error occurred during import:",f)}finally{h.addFooterButton("Close",()=>h.destroy()),await a.refresh()}}})}const be=wt.define(yt),On=vt({base:Et,codeLanguages:[Z.of({name:"javascript",load:()=>Promise.resolve(Ne())}),Z.of({name:"html",load:()=>Promise.resolve(Me())}),Z.of({name:"css",load:()=>Promise.resolve(Re())}),Z.of({name:"mermaid",load:()=>Promise.resolve(bt())})]});function pe(a){const e=a.split("/").pop(),t=e.includes(".")?e.split(".").pop().toLowerCase():"";switch(e){case".gitignore":case".npmrc":case".editorconfig":case"Dockerfile":return be}switch(t){case"js":return Ne();case"css":return Re();case"html":return Me();case"json":return kt();case"xml":return St();case"yaml":case"yml":return Ct();case"sh":case"bash":case"zsh":return be;default:return On}}const R=Fe.define({create:()=>({gitClient:null,sidebar:null,editor:null}),update:(a,e)=>a});async function ae(a,e){if(!e.sidebar||!e.gitClient)return null;const t=await e.sidebar.listAllPaths(e.gitClient,"/"),n=a.toLowerCase();for(const{path:s,isDirectory:i}of t){if(i)continue;const o=s;if((o.startsWith("/")?o.substring(1):o).toLowerCase()===n)return o}return null}async function Gn(a,e){const t=new k(a);try{return await t.readFile(e)}catch(n){if(n.message.includes("does not exist")&&a!=="Settings"){const s=new k("Settings");try{return await s.readFile(e)}catch(i){if(i.message.includes("does not exist"))return null;throw i}}if(n.message.includes("does not exist"))return null;throw n}}async function ee(a,e,t,n=null,s=null){try{let[i,o]=a.split("#");o.startsWith("/")||(o=`/${o}`);const r=await Gn(i,o);if(r===null)return;const c=`(function(editor, git, event, params) {
      try {
        ${r}
      } catch (e) {
        console.error(
...
${e.message}</pre></div>`;return Q.set(a,t),t}}class ls extends _e{constructor(e){super(),this.code=e}eq(e){return this.code===e.code}toDOM(){const e=document.createElement("div");return e.className="cm-mermaid-container",e.innerHTML="<p>Loading diagram...</p>",setTimeout(()=>{e.isConnected&&cs(this.code).then(t=>{e.innerHTML=t})},0),e}}function Se(a){const e=new A;return q(a.state).iterate({enter:n=>{if(n.name==="FencedCode"){const s=n.node.getChild("CodeInfo");if(s&&a.state.doc.sliceString(s.from,s.to).trim()==="mermaid"){const o=n.node.getChild("CodeText");if(o){const r=a.state.doc.sliceString(o.from,o.to);e.add(n.to,n.to,x.widget({widget:new ls(r),side:1}))}}}}}),e.finish()}const tt=L.fromClass(class{constructor(a){this.decorations=Se(a)}update(a){(a.docChanged||q(a.startState)!==q(a.state))&&(this.decorations=Se(a.view))}},{decorations:a=>a.decorations}),ds=[ze,We,Ve,Ke,Je,Ye,Xe,Ze,Qe,et,tt],nt=["png","jpg","jpeg","gif","svg","webp","avif"],ce=["mp4","webm","mov","ogg"],le=["mp3","wav","flac"],st=[...nt,...ce,...le];function hs(a){switch(a.toLowerCase()){case"png":return"image/png";case"jpg":case"jpeg":return"image/jpeg";case"gif":return"image/gif";case"svg":return"image/svg+xml";case"webp":return"image/webp";case"avif":return"image/avif";case"mp4":return"video/mp4";case"webm":return"video/webm";case"mov":return"video/quicktime";case"ogg":return"video/ogg";case"mp3":return"audio/mpeg";case"wav":return"audio/wav";case"flac":return"audio/flac";default:return"application/octet-stream"}}class ke extends _e{constructor(e,t,n,s){super(),this.linkTarget=e,this.altText=t,this.type=n,this.view=s,this.objectURL=null}eq(e){return this.linkTarget===e.linkTarget&&this.type===e.type}toDOM(){const e=document.createElement("span");e.className="cm-embed-container";const t=this.linkTarget.split(".").pop()?.toLowerCase().split("?")[0];if(this.type==="external"){let n;ce.includes(t)?(n=document.createElement("video"),n.className="cm-embedded-video",n.controls=!0):le.includes(t)?(n=document.createElement("audio"),n.className="cm-embedded-audio",n.controls=!0):(n=document.createElement("img"),n.className="cm-embedded-image",n.alt=this.altText),n.src=this.linkTarget,e.appendChild(n)}else{const n=document.createElement("span");n.className="cm-embed-placeholder",n.textContent=`Loading: ${this.linkTarget}`,e.appendChild(n),this.loadInternalContent(e).catch(s=>{console.error(`Failed to load internal embed for ${this.linkTarget}:`,s),n.textContent=`Error: ${this.linkTarget} not found.`,e.classList.add("cm-embed-error")})}return e}async loadInternalContent(e){let n=decodeURIComponent(this.linkTarget),s=null;n.includes("#")&&([s,n]=n.split("#"));const i=n.split(".").pop()?.toLowerCase(),o=this.view.state.field(R);let r;s&&s!==o.gitClient.gardenName?r=new k(s):r=o.gitClient;const c=n.startsWith("/")?n:`/${n}`;if(st.includes(i)){const l=await r.readFileAsBuffer(c);if(!l)throw new Error("File could not be read as a buffer.");const h=hs(i),u=new Blob([l],{type:h});this.objectURL=URL.createObjectURL(u);let d;nt.includes(i)?(d=document.createElement("img"),d.className="cm-embedded-image",d.alt=this.linkTarget):ce.includes(i)?(d=document.createElement("video"),d.className="cm-embedded-video",d.controls=!0):le.includes(i)&&(d=document.createElement("audio"),d.className="cm-embedded-audio",d.controls=!0),d.src=this.objectURL,e.innerHTML="",e.appendChild(d),(d.tagName==="VIDEO"||d.tagName==="AUDIO")&&(d.onerror=g=>{console.error("Embedded media playback error:",g),e.innerHTML=`<span class="cm-embed-error">Error playing: ${this.linkTarget}</span>`},d.load())}else{const l=await r.readFile(c);if(l==null)throw new Error("File content could not be read.");e.innerHTML="",e.classList.add("cm-embedded-content");const h=ue.create({doc:l,extensions:[je,he(De,{fallback:!0}),pe(n),M.lineWrapping,M.editable.of(!1),...ds]});new M({state:h,parent:e})}}destroy(){this.objectURL&&URL.revokeObjectURL(this.objectURL)}}function Ee(a){const e=new A,t=q(a.state),n=a.state.selection,s=new Set;for(const o of n.ranges)s.add(a.state.doc.lineAt(o.head).number);const i=o=>{let r=t.resolve(o,1);for(;r;){if(r.name.includes("Code"))return!0;r=r.parent}return!1};for(const{from:o,to:r}of a.visibleRanges){const c=a.state.doc.sliceString(o,r),l=/!\[\[([^\[\]]+?)\]\]/g;let h;for(;h=l.exec(c);){const d=o+h.index,g=a.state.doc.lineAt(d);if(i(d)||s.has(g.number))continue;const f=d+h[0].length,p=h[1];e.add(d,f,x.replace({widget:new ke(p,p,"internal",a)}))}const u=/!\[(.*?)\]\((.*?)\)/g;for(;h=u.exec(c);){const d=o+h.index,g=a.state.doc.lineAt(d);if(i(d)||s.has(g.number))continue;const f=d+h[0].length,p=h[1],y=h[2],v=y.split(".").pop()?.toLowerCase()?.split("?")[0];y.startsWith("http")&&st.includes(v)&&e.add(d,f,x.replace({widget:new ke(y,p,"external",a)}))}}return e.finish()}const us=L.fromClass(class{constructor(a){this.decorations=Ee(a)}update(a){(a.docChanged||a.viewportChanged||a.selectionSet||q(a.startState)!==q(a.state))&&(this.decorations=Ee(a.view))}},{decorations:a=>a.decorations}),gs=[ze,We,Ve,Ke,Je,Ye,Xe,us,Ze,Qe,et,tt],fs=x.mark({class:"cm-diff-inserted"});function xe(a,e){const t=[],n=e.doc.toString(),s=ne(a,n);let i=0;for(const[o,r]of s)o===ne.INSERT&&t.push(fs.range(i,i+r.length)),o!==ne.DELETE&&(i+=r.length);return x.set(t)}const de=new G;function ps(a){return Fe.define({create(e){return xe(a,e)},update(e,t){return t.docChanged?xe(a,t.state):e.map(t.changes)},provide:e=>M.decorations.from(e)})}const ms=new G,it=L.fromClass(class{constructor(a){this.view=a,this.statusBar=document.createElement("div"),this.statusBar.className="status-bar",this.filePathElement=document.createElement("span"),this.filePathElement.className="status-bar-filepath",this.tokenCountElement=document.createElement("span"),this.tokenCountElement.className="status-bar-token-count",this.statusBar.appendChild(this.filePathElement),this.statusBar.appendChild(this.tokenCountElement),a.dom.parentElement?a.dom.parentElement.appendChild(this.statusBar):console.error("Could not find a parent element for the editor view to attach the status bar."),this.debouncedUpdate=re(this.updateAll.bind(this),100),this.updateAll()}update(a){(a.docChanged||a.selectionSet||a.viewportChanged)&&this.debouncedUpdate()}getDisplayPath(){const a=this.view.state.field(R);if(!a||!a.editor)return"...";const e=a.editor.gitClient.gardenName,t=a.editor.filePath||"/untitled";return`[${e}] ${t}`}updateAll(){if(!this.view.dom.isConnected)return;const a=this.getDisplayPath();this.filePathElement.textContent!==a&&(this.filePathElement.textContent=a);try{const e=this.view.state.doc.toString(),n=`Tokens: ${B(e).toLocaleString()}`;this.tokenCountElement.textContent!==n&&(this.tokenCountElement.textContent=n)}catch{this.tokenCountElement.textContent="Tokens: Error"}}destroy(){this.debouncedUpdate.cancel(),this.statusBar&&this.statusBar.remove()}});function ws(){return it}function ys({appContext:a,dynamicKeymapExtension:e,vimCompartment:t,defaultKeymapCompartment:n,languageCompartment:s,appContextCompartment:i,updateListener:o,filePath:r,getLanguageExtension:c}){return[i.of(a),e,t.of([]),n.of(U.of(Oe)),U.of([Ut]),Tt(),Pt(),$t(),It(),Lt(),At(),Nt(),ue.allowMultipleSelections.of(!0),Mt(),he(De,{fallback:!0}),Rt(),Ft(),_t(),Dt(),Ot(),Gt(),U.of([...qt,...Ht,...jt,...zt,...Wt,...Vt]),M.lineWrapping,Bt,je,s.of(c(r)),o,...gs,de.of([]),ms.of(ws()),M.domEventHandlers({drop(l,h){return l.dataTransfer&&l.dataTransfer.files.length>0?(l.preventDefault(),!0):!1}})]}async function ot(a){const e=new Date,t=String(e.getFullYear()).slice(-2),n=String(e.getMonth()+1).padStart(2,"0"),s=String(e.getDate()).padStart(2,"0"),i=String(e.getHours()).padStart(2,"0"),o=String(e.getMinutes()).padStart(2,"0"),r=`${t}${n}${s}-${i}${o}`,c="/scratchpad";await a.ensureDir(c);let l=`${c}/${r}`,h=0;for(;;)try{await a.pfs.stat(l),h++,l=`${c}/${r}-${h}`}catch(u){if(u.code==="ENOENT")break;throw u}return l}class vs{constructor(e){this.editor=e}getFilePath(e){let t=e.startsWith("#")?e.substring(1):e;return t=decodeURIComponent(t),t||(t="home"),t}async loadFileContent(e){try{return await this.editor.gitClient.readFile(e)}catch(t){return t.message&&t.message.includes("does not exist")||console.warn(`An unexpected error occurred while reading ${e}:`,t),`// "${e.substring(1)}" does not exist. Start typing to create it.`}}async loadFile(e){const t=["png","jpg","jpeg","gif","svg","webp","avif"],n=["mp4","webm","mov","ogg"],s=["mp3","wav","flac"],i=[...t,...n,...s],o=e.split(".").pop()?.toLowerCase();if(i.includes(o)){this.editor.hideDiff(),this.editor.targetElement.classList.remove("is-editor"),this.editor.targetElement.classList.add("is-media-preview"),this.editor.mediaViewerElement.innerHTML="<p>Loading media...</p>";const h=await this.editor.gitClient.readFileAsBuffer(e);if(h){const d={png:"image/png",jpg:"image/jpeg",jpeg:"image/jpeg",gif:"image/gif",svg:"image/svg+xml",webp:"image/webp",avif:"image/avif",mp4:"video/mp4",webm:"video/webm",mov:"video/quicktime",ogg:"video/ogg",mp3:"audio/mpeg",wav:"audio/wav",flac:"audio/flac"}[o]||"application/octet-stream",g=new Blob([h],{type:d});this.editor.currentMediaObjectUrl&&URL.revokeObjectURL(this.editor.currentMediaObjectUrl),this.editor.currentMediaObjectUrl=URL.createObjectURL(g);let f="";t.includes(o)?f=`<img src="${this.editor.currentMediaObjectUrl}" alt="${e}" />`:n.includes(o)?f=`<video src="${this.editor.currentMediaObjectUrl}" controls></video>`:s.includes(o)&&(f=`<audio src="${this.editor.currentMediaObjectUrl}" controls></audio>`),this.editor.mediaViewerElement.innerHTML=f;const p=this.editor.mediaViewerElement.querySelector("video, audio");p&&p.load()}else this.editor.mediaViewerElement.innerHTML=`<p class="error">Could not load media: ${e}</p>`;this.editor.filePath=e,this.editor.sidebar&&await this.editor.sidebar.refresh(),await this.editor._applyUserSettings();return}this.editor.targetElement.classList.remove("is-media-preview"),this.editor.targetElement.classList.add("is-editor"),this.editor.currentMediaObjectUrl&&(URL.revokeObjectURL(this.editor.currentMediaObjectUrl),this.editor.currentMediaObjectUrl=null),this.editor.hideDiff();const r=await this.loadFileContent(e);this.editor.filePath=e;const c=pe(e);this.editor.editorView.dispatch({effects:this.editor.languageCompartment.reconfigure(c)});const l=this.editor.editorView.state.doc;this.editor.editorView.dispatch({changes:{from:0,to:l.length,insert:r},annotations:this.editor.programmaticChange.of(!0)}),this.editor.sidebar&&await this.editor.sidebar.refresh(),await this.editor._applyUserSettings()}async forceReloadFile(e){if(this.editor.filePath!==e||!this.editor.editorView){await this.loadFile(e);return}const t=this.editor.editorView.state.selection,n=this.editor.editorView.scrollDOM.scrollTop,s=await this.loadFileContent(e),i=this.editor.editorView.state.doc;if(s===i.toString())return;const o=s.length,r={changes:{from:0,to:i.length,insert:s},annotations:this.editor.programmaticChange.of(!0),selection:{anchor:Math.min(t.main.anchor,o),head:Math.min(t.main.head,o)}};this.editor.editorView.dispatch(r),requestAnimationFrame(()=>{this.editor.editorView&&this.editor.editorView.scrollDOM&&(this.editor.editorView.scrollDOM.scrollTop=n)})}async newFile(){try{const e=await b.prompt({title:"New File",label:"Enter file name (or leave blank for a scratchpad):"});if(e===null){this.editor.editorView?.focus();return}let t;if(!e.trim())t=await ot(this.editor.gitClient);else{const n=e.trim();t=`/${n}`;try{const i=(await this.editor.gitClient.pfs.stat(t)).isDirectory()?"folder":"file";await this.editor.sidebar.showAlert({title:"Creation Failed",message:`A ${i} named "${n}" already exists.`});return}catch(s){if(s.code!=="ENOENT"){console.error("Error checking for file:",s),await this.editor.sidebar.showAlert({title:"Error",message:"An unexpected error occurred."});return}}}window.thoughtform.workspace.openFile(this.editor.gitClient.gardenName,t)}finally{}}async duplicateFile(e){if(e)try{if((await this.editor.gitClient.pfs.stat(e)).isDirectory()){await this.editor.sidebar.showAlert({title:"Action Not Supported",message:"Duplicating folders is not yet supported."});return}const n=e.substring(0,e.lastIndexOf("/")),s=e.substring(e.lastIndexOf("/")+1),i=`${s.split(".").slice(0,-1).join(".")||s} (copy)${s.includes(".")?"."+s.split(".").pop():""}`,o=await b.prompt({title:"Duplicate File",label:"Enter name for duplicated file:",defaultValue:i});if(o===null){this.editor.editorView?.focus();return}if(!o.trim())return;const r=`${n}/${o.trim()}`;try{const c=await this.editor.gitClient.readFile(e);await this.editor.gitClient.writeFile(r,c),window.thoughtform.workspace.openFile(this.editor.gitClient.gardenName,r)}catch(c){console.error("Error duplicating file:",c),await this.editor.sidebar.showAlert({title:"Error",message:`Failed to duplicate file: ${c.message}`})}}finally{}}}class bs{constructor(e){this.editor=e}async showDiff(e){if(e===null){this.hideDiff();return}const t=ps(e);this.editor.editorView.dispatch({effects:de.reconfigure(t)})}hideDiff(){this.editor.editorView.dispatch({effects:de.reconfigure([])})}async previewHistoricalFile(e,t,n){const[s,i]=await Promise.all([this.editor.gitClient.readBlobFromCommit(t,e),this.editor.gitClient.readBlobFromCommit(n,e)]);if(s===null||i===null){await this.editor.sidebar.showAlert({title:"Error",message:"Could not load historical diff for this file."});return}this.editor.editorView.dispatch({changes:{from:0,to:this.editor.editorView.state.doc.length,insert:s},annotations:this.editor.programmaticChange.of(!0)}),this.showDiff(i)}}class Cs{constructor(e){this.editor=e}getCurrentState(){return this.editor.editorView?{selection:{main:{anchor:this.editor.editorView.state.selection.main.anchor,head:this.editor.editorView.state.selection.main.head}},scrollTop:this.editor.editorView.scrollDOM.scrollTop}:null}restoreState(e){if(!this.editor.editorView||!e)return;const t=this.editor.editorView.state.update({selection:{anchor:e.selection.main.anchor,head:e.selection.main.head}});this.editor.editorView.dispatch(t),requestAnimationFrame(()=>{this.editor.editorView.scrollDOM&&(this.editor.editorView.scrollDOM.scrollTop=e.scrollTop)})}}class me{static editors=[];constructor({target:e,editorConfig:t={},gitClient:n,commandPalette:s,initialFile:i,paneId:o}){if(!n)throw new Error("Editor requires a gitClient instance.");if(!s)throw new Error("Editor requires a commandPalette instance.");this.targetElement=typeof e=="string"?document.querySelector(e):e,this.editorConfig=t,this.gitClient=n,this.commandPalette=s,this.paneId=o,this.editorView=null,this.sidebar=null,this.filePath=i||"/home",this.isReady=!1,this.keymapService=null,this.languageCompartment=new G,this.vimCompartment=new G,this.defaultKeymapCompartment=new G,this.appContextCompartment=new G,this.mediaViewerElement=null,this.currentMediaObjectUrl=null,this.programmaticChange=Kt.define(),this._files=new vs(this),this._git=new bs(this),this._state=new Cs(this),this.debouncedHandleUpdate=re(this.handleUpdate.bind(this),500),this.debouncedStateSave=re(()=>{window.thoughtform.workspace?._saveStateToSession()},500),this.init()}async init(){if(!this.targetElement){console.error("Target container not found or provided.");return}if(document.querySelector("#sidebar").hasChildNodes())this.sidebar=window.thoughtform.sidebar;else{await this.gitClient.initRepo(),this.sidebar=new _n({target:"#sidebar",gitClient:this.gitClient,editor:this}),await this.sidebar.init(),window.thoughtform._dragDropInitialized||(Dn(this.sidebar),window.thoughtform._dragDropInitialized=!0);const r=document.getElementById("loading-indicator");r&&r.remove(),document.querySelector(".main-content").style.display="flex"}window.thoughtform.sidebar||(window.thoughtform.sidebar=this.sidebar);let e=await this._files.loadFileContent(this.filePath);this.mediaViewerElement=document.createElement("div"),this.mediaViewerElement.className="media-viewer-container",this.targetElement.appendChild(this.mediaViewerElement);const t=M.updateListener.of(r=>{r.docChanged&&!r.transactions.some(c=>c.annotation(this.programmaticChange))&&this.debouncedHandleUpdate(r.state.doc.toString()),(r.selectionSet||r.viewportChanged)&&this.debouncedStateSave()}),n=ue.create({doc:e}),s=new M({state:n});this.keymapService=new Hn(s);const i=this.keymapService.getCompartment(),o=ys({appContext:R.init(()=>({gitClient:this.gitClient,sidebar:this.sidebar,editor:this})),dynamicKeymapExtension:i,vimCompartment:this.vimCompartment,defaultKeymapCompartment:this.defaultKeymapCompartment,languageCompartment:this.languageCompartment,appContextCompartment:this.appContextCompartment,updateListener:t,filePath:this.filePath,getLanguageExtension:pe});this.editorView=new M({doc:e,extensions:o,parent:this.targetElement}),this.keymapService.editorView=this.editorView,s.destroy(),me.editors.push(this),this.isReady=!0,await this.loadFile(this.filePath)}async _applyUserSettings(){const{value:e}=await window.thoughtform.config.get("interface.yml","editingMode",this);e==="vim"?(Jt.map("jj","<Esc>","insert"),this.editorView.dispatch({effects:[this.vimCompartment.reconfigure(Yt()),this.defaultKeymapCompartment.reconfigure([])]})):this.editorView.dispatch({effects:[this.vimCompartment.reconfigure([]),this.defaultKeymapCompartment.reconfigure(U.of(Oe))]}),this.keymapService&&await this.keymapService.updateKeymaps()}async navigateTo(e){if(!e)return;let t=e.split("|")[0].trim(),n=null;if(t.includes("#")&&([n,t]=t.split("#")),n&&n!==this.gitClient.gardenName)window.thoughtform.workspace.openFile(n,t.startsWith("/")?t:`/${t}`);else{const s=this.gitClient.gardenName;let o=await ae(t,{gitClient:this.gitClient,sidebar:this.sidebar})||(t.startsWith("/")?t:`/${t}`);window.thoughtform.workspace.openFile(s,o)}}async handleUpdate(e){this.isReady&&(await this.gitClient.writeFile(this.filePath,e),window.thoughtform.events.publish("file:update",{gardenName:this.gitClient.gardenName,path:this.filePath,content:e}),window.thoughtform.workspace.notifyFileUpdate(this.gitClient.gardenName,this.filePath,this.paneId),this.sidebar&&await this.sidebar.refresh())}refreshStatusBar(){if(this.editorView){const e=this.editorView.plugin(it);e&&e.updateAll()}}getFilePath(e){return this._files.getFilePath(e)}loadFileContent(e){return this._files.loadFileContent(e)}loadFile(e){return this._files.loadFile(e)}forceReloadFile(e){return this._files.forceReloadFile(e)}newFile(){return this._files.newFile()}duplicateFile(e){return this._files.duplicateFile(e)}showDiff(e){return this._git.showDiff(e)}hideDiff(){return this._git.hideDiff()}previewHistoricalFile(e,t,n){return this._git.previewHistoricalFile(e,t,n)}getCurrentState(){return this._state.getCurrentState()}restoreState(e){return this._state.restoreState(e)}}function Ss(){ks(),Es()}function ks(){const a=document.querySelector(".app-container"),e=document.getElementById("resizer"),t=document.getElementById("resize-overlay");if(!a||!e||!t)return;const n=document.createElement("button");n.id="sidebar-toggle-icon",n.title="Toggle Sidebar (Ctrl + [)",e.appendChild(n);let s=0,i=!1;const o=()=>{if(a.classList.contains("sidebar-collapsed")){const g=localStorage.getItem("sidebarWidth")||"250px";a.classList.remove("sidebar-collapsed"),document.documentElement.style.setProperty("--sidebar-width",g),localStorage.setItem("sidebarCollapsed","false"),n.textContent="‹"}else{const g=document.documentElement.style.getPropertyValue("--sidebar-width");g!=="0px"&&localStorage.setItem("sidebarWidth",g),a.classList.add("sidebar-collapsed"),document.documentElement.style.setProperty("--sidebar-width","0px"),localStorage.setItem("sidebarCollapsed","true"),n.textContent="›"}};window.thoughtform&&window.thoughtform.ui&&(window.thoughtform.ui.toggleSidebar=o);const r=d=>{d.type==="touchmove"&&d.preventDefault();const g=d.clientX||d.touches&&d.touches[0].clientX;if(Math.abs(g-s)>5&&(i=!0),i){const f=Math.max(24,Math.min(g,window.innerWidth-100));document.documentElement.style.setProperty("--sidebar-width",`${f}px`),a.classList.remove("sidebar-collapsed"),n.textContent="‹"}},c=()=>{if(t.style.display="none",document.body.style.cursor="default",document.body.style.userSelect="auto",document.removeEventListener("mousemove",r),document.removeEventListener("touchmove",r),document.removeEventListener("mouseup",c),document.removeEventListener("touchend",c),i){const d=document.documentElement.style.getPropertyValue("--sidebar-width");localStorage.setItem("sidebarWidth",d),localStorage.setItem("sidebarCollapsed","false")}else o()},l=d=>{s=d.clientX||d.touches&&d.touches[0].clientX,i=!1,d.preventDefault(),t.style.display="block",document.body.style.cursor="col-resize",document.body.style.userSelect="none",document.addEventListener("mousemove",r,{passive:!1}),document.addEventListener("touchmove",r,{passive:!1}),document.addEventListener("mouseup",c),document.addEventListener("touchend",c)};e.addEventListener("mousedown",l),e.addEventListener("touchstart",l,{passive:!1});const h=localStorage.getItem("sidebarWidth");localStorage.getItem("sidebarCollapsed")==="true"?(a.classList.add("sidebar-collapsed"),document.documentElement.style.setProperty("--sidebar-width","0px"),n.textContent="›"):(document.documentElement.style.setProperty("--sidebar-width",h||"250px"),n.textContent="‹")}function Es(){const a=document.getElementById("eruda-container"),e=document.getElementById("eruda-resizer");let t;if(!a||!e)return;const n=document.createElement("button");n.id="eruda-toggle",n.title="Toggle DevTools (Ctrl + `)",e.appendChild(n);let s=0,i=!1;const o=(u=null,d=null)=>{if(t=document.querySelector(".eruda-dev-tools"),!t)return;const g=t.style.height==="0px"||t.offsetHeight<10;if(u===null?g:u){const p=localStorage.getItem("erudaHeight")||"250px";t.style.height=p,n.textContent="▼",localStorage.setItem("erudaCollapsed","false"),d&&setTimeout(()=>window.thoughtform.eruda?.show(d),50)}else{if(g)return;localStorage.setItem("erudaHeight",t.style.height),t.style.height="0px",n.textContent="▲",localStorage.setItem("erudaCollapsed","true")}};window.thoughtform&&window.thoughtform.ui&&(window.thoughtform.ui.toggleDevtools=o);const r=u=>{u.type==="touchmove"&&u.preventDefault();const d=u.clientY||u.touches&&u.touches[0].clientY;if(Math.abs(d-s)>5&&(i=!0),!i)return;const g=window.innerHeight-d,f=42,p=window.innerHeight-100;t.style.height=`${Math.max(f,Math.min(g,p))}px`,n.textContent="▼"},c=()=>{document.body.style.cursor="default",document.body.style.userSelect="auto",document.removeEventListener("mousemove",r),document.removeEventListener("touchmove",r),document.removeEventListener("mouseup",c),document.removeEventListener("touchend",c),i?(localStorage.setItem("erudaHeight",t.style.height),localStorage.setItem("erudaCollapsed","false")):o(null,null)},l=u=>{s=u.clientY||u.touches&&u.touches[0].clientY,i=!1,u.preventDefault(),t=document.querySelector(".eruda-dev-tools"),t&&(document.body.style.cursor="row-resize",document.body.style.userSelect="none",document.addEventListener("mousemove",r),document.addEventListener("touchmove",r,{passive:!1}),document.addEventListener("mouseup",c),document.addEventListener("touchend",c))};e.addEventListener("mousedown",l),e.addEventListener("touchstart",l,{passive:!1});const h=new MutationObserver(()=>{t=document.querySelector(".eruda-dev-tools"),t&&(localStorage.getItem("erudaCollapsed")==="true"?(t.style.height="0px",n.textContent="▲"):(t.style.height=localStorage.getItem("erudaHeight")||"150px",n.textContent="▼"),h.disconnect())});h.observe(a,{childList:!0})}class xs{constructor(){const e=new URLSearchParams(window.location.search);this.isEnabled=e.has("debug"),console.log(`[DEBUG] Debug mode is ${this.isEnabled?"ENABLED":"DISABLED"}`)}log(...e){this.isEnabled&&console.log("[DEBUG]",...e)}error(...e){this.isEnabled&&console.error("[DEBUG]",...e)}warn(...e){this.isEnabled&&console.warn("[DEBUG]",...e)}}const C=new xs;class Ts{constructor(e){this.signaling=e}connectToSignalingServer(){return new Promise((e,t)=>{const n=this.signaling.signalingServerUrl;if(this.signaling.ws&&this.signaling.ws.readyState===WebSocket.OPEN){e();return}this.signaling.ws=new WebSocket(n),this.signaling.ws.onopen=()=>{C.log(`Connected to signaling server at ${n}`),e()},this.signaling.ws.onclose=()=>{C.log("Disconnected from signaling server"),this.signaling.sync.disconnect()},this.signaling.ws.onerror=s=>{C.error("WebSocket error:",s),this.signaling.sync.updateConnectionState("error","Signaling server connection error."),t(new Error(`Failed to connect to signaling server at ${n}`))},this.signaling.ws.onmessage=s=>{try{const i=JSON.parse(s.data);this.signaling._signalingMessageHandler&&this.signaling._signalingMessageHandler.handleSignalingMessage(i)}catch(i){C.error("Error parsing signaling message:",i)}}})}sendJoinSessionRequest(e,t){const n=this.signaling.ws;if(n&&n.readyState===WebSocket.OPEN){const s={type:"join_session",sessionId:e};t&&(s.peerNamePrefix=t),n.send(JSON.stringify(s))}else C.error("Cannot send join session request, WebSocket is not open.")}sendSignal(e,t){const n=this.signaling.ws;n&&n.readyState===WebSocket.OPEN&&n.send(JSON.stringify({type:"signal",target:t,data:e}))}}class Ps{constructor(e){this.signaling=e}handleSignalingMessage(e){const t=this.signaling.sync;switch(e.type){case"welcome":C.log("Received welcome from signaling server.");break;case"session_joined":this.signaling.peerId=e.peerId,t.updateConnectionState("connected-signal","Connected to tracker, waiting for peers..."),e.peers&&e.peers.length>0&&e.peers.forEach(n=>{this.signaling.connectToPeer(n)});break;case"peer_joined":this.signaling.connectToPeer(e.peerId);break;case"signal":e.from&&e.data&&this.signaling.handleSignal(e.from,e.data);break;case"peer_left":e.peerId&&t.handlePeerLeft(e.peerId);break;case"error":t.updateConnectionState("error",`Signaling error: ${e.message}`);break}}}const $s=500;class Is{constructor(e){this.signaling=e,this.sync=e.sync,this.seenMessages=new Set}handleIncomingMessage(e,t){if(!e.payload||!e.messageId){C.warn("Received a message without a payload or messageId, cannot process.",e);return}if(this.seenMessages.has(e.messageId))return;if(this.seenMessages.add(e.messageId),this.seenMessages.size>$s){const s=this.seenMessages.values().next().value;this.seenMessages.delete(s)}e.noGossip||this.sendSyncMessage(e.payload,null,e.messageId);const n=e.payload;switch(n.type){case"peer_introduction":this.sync.handlePeerIntroduction(n);break;default:this.sync.fileSync&&this.sync.fileSync.handleSyncMessage(n);break}}sendSyncMessage(e,t=null,n=null){const s=n||crypto.randomUUID(),o=JSON.stringify({messageId:s,payload:e,noGossip:!!t});if(this.seenMessages.add(s),t){const r=this.sync.peerConnections.get(t);if(r&&r.dataChannel&&r.dataChannel.readyState==="open")try{r.dataChannel.send(o)}catch(c){console.error(`Error sending direct message to ${t.substring(0,8)}...:`,c)}}else this.sync.peerConnections.forEach((r,c)=>{if(r.dataChannel&&r.dataChannel.readyState==="open")try{r.dataChannel.send(o)}catch(l){console.error(`Error gossiping message to ${c.substring(0,8)}...:`,l)}})}destroy(){this.seenMessages.clear()}}class Ls{constructor(e){this.signaling=e}async connectToPeer(e){const t=this.signaling.sync,n=t.createPeerConnection(e,!0);if(n)try{const s=n.createDataChannel("syncChannel");t.setupDataChannel(e,s);const i=await n.createOffer();await n.setLocalDescription(i),this.signaling.sendSignal({type:"offer",sdp:i.sdp},e)}catch(s){C.error(`Failed to initiate connection to ${e}:`,s)}}}class As{constructor(e){this.sync=e,this.ws=null,this.signalingServerUrl=localStorage.getItem("thoughtform_signaling_server")||"wss://socket.thoughtform.garden",this.peerId=null,this._webSocketManager=new Ts(this),this._signalingMessageHandler=new Ps(this),this._webrtcInitiator=new Ls(this),this._syncMessageRouter=new Is(this)}updateSignalingServerUrl(e){this.signalingServerUrl=e,localStorage.setItem("thoughtform_signaling_server",e)}async joinSession(e,t){try{await this._webSocketManager.connectToSignalingServer(),this._webSocketManager.sendJoinSessionRequest(e,t)}catch{this.sync.updateConnectionState("error","Failed to connect to signaling server.")}}connectToPeer(e){e!==this.peerId&&this.peerId>e&&this._webrtcInitiator.connectToPeer(e)}sendSignal(e,t){this._webSocketManager.sendSignal(e,t)}async handleSignal(e,t){const n=this.sync;try{let s=n.peerConnections.get(e);if(!s)if(t.type==="offer"){if(s=n.createPeerConnection(e,!1),!s){console.warn(`[SYNC-SIGNAL] Received offer from ${e.substring(0,8)} but at connection limit. Ignoring.`);return}}else{C.warn(`[SYNC-SIGNAL] Received signal from unknown peer ${e.substring(0,8)} before an offer. Discarding.`);return}if(t.type==="offer"){await s.setRemoteDescription(new RTCSessionDescription(t));const i=await s.createAnswer();await s.setLocalDescription(i),this.sendSignal({type:"answer",sdp:i.sdp},e)}else t.type==="answer"?await s.setRemoteDescription(new RTCSessionDescription(t)):t.type==="candidate"&&await s.addIceCandidate(new RTCIceCandidate(t.candidate))}catch(s){C.error(`Error handling signal from ${e}:`,s)}}sendSyncMessage(e,t,n){this._syncMessageRouter.sendSyncMessage(e,t,n)}handleIncomingMessage(e,t){this._syncMessageRouter.handleIncomingMessage(e,t)}destroy(){this.ws&&(this.ws.close(),this.ws=null),this._syncMessageRouter.destroy()}}class Ns{constructor(){this._listeners={}}addEventListener(e,t){e in this._listeners||(this._listeners[e]=[]),this._listeners[e].push(t)}removeEventListener(e,t){if(!(e in this._listeners))return;const n=this._listeners[e];for(let s=0,i=n.length;s<i;s++)if(n[s]===t){n.splice(s,1);return}}dispatchEvent(e){if(!(e.type in this._listeners))return!0;const t=this._listeners[e.type].slice();for(let n=0,s=t.length;n<s;n++)t[n].call(this,e);return!e.defaultPrevented}destroy(){this._listeners={}}}class Ms{static getGitClient(e){if(e.gitClient)return e.gitClient;if(e.sync&&e.sync.gitClient)return e.sync.gitClient;if(window.thoughtform){for(const t in window.thoughtform)if(window.thoughtform[t]&&typeof window.thoughtform[t]=="object"){if(window.thoughtform[t].hasOwnProperty("readFile")&&window.thoughtform[t].hasOwnProperty("writeFile"))return C.log(`DEBUG: Found potential gitClient-like object at window.thoughtform.${t}`),window.thoughtform[t];if(window.thoughtform[t].gitClient)return C.log(`DEBUG: Found gitClient at window.thoughtform.${t}.gitClient`),window.thoughtform[t].gitClient}if(window.thoughtform.gitClient)return C.log("DEBUG: Found gitClient at window.thoughtform.gitClient"),window.thoughtform.gitClient;if(window.thoughtform.editor&&window.thoughtform.editor.gitClient)return C.log("DEBUG: Found gitClient at window.thoughtform.editor.gitClient"),window.thoughtform.editor.gitClient}return C.log("DEBUG: _getGitClient: No gitClient found in standard locations or window.thoughtform"),null}}class Rs{static setupDataChannel(e,t){t.onopen=()=>{e.sync.isConnected=!0,e.sync.ui.showMessages(),e.sync.addMessage("File sync data channel is open."),C.log("DEBUG: SyncFiles confirmed data channel is open.")},t.onmessage=async n=>{try{const s=JSON.parse(n.data);await e.sync._handleIncomingSyncMessage(s,"P2P")}catch(s){console.error("Error parsing sync message from DataChannel:",s,"Raw data:",n.data)}},t.onclose=()=>{e.sync.isConnected=!1,e.sync.ui.hideMessages(),e.sync.addMessage("File sync data channel closed."),C.log("DEBUG: SyncFiles confirmed data channel is closed.")},t.onerror=n=>{const s=n.error;s&&s.name==="OperationError"&&s.message.includes("User-Initiated Abort")?C.log("Data channel closed intentionally by a peer.",n):(console.error("Data channel error:",n),e.sync.addMessage("Data channel error: "+(s?s.message:"Unknown error")))}}}class rt{static async _listAllFiles(e,t){const n=e.pfs;if(!n)throw new Error("gitClient does not have pfs property");let s=[];try{const i=await n.readdir(t);for(const o of i){if(o===".git")continue;const r=t==="/"?`/${o}`:`${t}/${o}`;try{(await n.stat(r)).isDirectory()?s=s.concat(await this._listAllFiles(e,r)):s.push(r)}catch(c){C.warn(`Could not stat ${r}, skipping.`,c)}}}catch(i){C.log(`Directory not readable: ${t}`,i)}return s}static async handleFileUpdate(e,t){e.incrementPendingWrites();try{if(!t.gardenName)throw new Error("Received file update without a gardenName during a full sync.");const n=new k(t.gardenName);if(t.isFullSync){e.deletedGitDirs.has(t.gardenName)||(e.deletedGitDirs.add(t.gardenName),e.dispatchEvent(new CustomEvent("syncProgress",{detail:{message:`Preparing to receive garden: ${t.gardenName}...`,type:"info"}})),await n.initRepo(),e.dispatchEvent(new CustomEvent("syncProgress",{detail:{message:`Replacing git history for ${t.gardenName}...`,type:"info"}})),await n.rmrf("/.git")),e.dispatchEvent(new CustomEvent("syncProgress",{detail:{message:`Writing: ${t.path.substring(1)} (${t.gardenName})`,type:"info"}}));const s=Buffer.from(t.content,"base64");await n.writeFile(t.path,s)}else{const s=t.isBase64?Buffer.from(t.content,"base64"):t.content;await n.writeFile(t.path,s),e.sync.addMessage(`Updated file: ${t.path} in garden ${t.gardenName}`)}}catch(n){console.error("Error handling file update for path:",t.path,n),e.dispatchEvent(new CustomEvent("syncProgress",{detail:{message:`Error updating file ${t.path}: ${n.message}`,type:"error"}}))}finally{e.decrementPendingWrites()}}}class at{static async handleSyncMessage(e,t){switch(t.type){case"send_initiation":this.handleSendInitiation(e,t);break;case"sync_cancel":this.handleSyncCancel(e,t);break;case"file_update":await rt.handleFileUpdate(e,t);break;case"request_gardens":await this.handleRequestGardens(e,t.gardens,t.requesterId);break;case"garden_zip_chunk":await this.handleGardenZipChunk(e,t);break;case"garden_zip_complete":await this.handleGardenZipComplete(e,t);break;case"full_sync_complete":e.dispatchEvent(new CustomEvent("syncProgress",{detail:{message:"File stream complete. Waiting for writes to finish...",type:"info"}})),e.markSyncStreamAsComplete();break;default:C.log("Unknown sync message type:",t.type)}}static handleSendInitiation(e,t){e.isSyncCancelled||(e.currentTransferId=t.transferId,e.dispatchEvent(new CustomEvent("syncProgress",{detail:{message:`Incoming transfer from peer for gardens: ${t.gardens.join(", ")}.`,type:"info"}})))}static handleSyncCancel(e,t){e.currentTransferId===t.transferId&&e.cancelSync(!1)}static async handleRequestGardens(e,t=[],n){if(!n){const s="Error: Received garden request without a requesterId. Cannot send response.";console.error(s),e.dispatchEvent(new CustomEvent("syncProgress",{detail:{message:s,type:"error"}}));return}e.dispatchEvent(new CustomEvent("syncProgress",{detail:{message:`Received request for gardens: ${t.join(", ")} from ${n.substring(0,8)}...`,type:"info"}})),await this.sendGardens(e,t,[n])}static async sendGardens(e,t,n){if(!t||t.length===0||!n||n.length===0)return;const s=crypto.randomUUID();e.currentTransferId=s,e.targetPeers=n,e.sync.sendSyncMessage({type:"send_initiation",gardens:t,transferId:s});const i=64*1024,o=10*1024*1024,r=c=>new Promise(l=>{if(c.bufferedAmount<o)l();else{const h=()=>{c.bufferedAmount<o&&(c.removeEventListener("bufferedamountlow",h),l())};c.addEventListener("bufferedamountlow",h)}});try{for(const c of t){if(e.isSyncCancelled)throw new Error("Sync cancelled by user.");e.dispatchEvent(new CustomEvent("syncProgress",{detail:{message:`Preparing ${c} for transfer...`,type:"info"}}));const l=new K,h=new k(c),u=await this.getAllFilesIncludingGit(h.pfs,"/");e.dispatchEvent(new CustomEvent("syncProgress",{detail:{message:`Zipping ${u.length} files from ${c}...`,type:"info"}}));for(const p of u){if(e.isSyncCancelled)throw new Error("Sync cancelled by user.");const y=await h.pfs.readFile(p),v=p.startsWith("/")?p.substring(1):p;l.file(v,y)}if(e.isSyncCancelled)throw new Error("Sync cancelled by user.");const d=await l.generateAsync({type:"uint8array",compression:"DEFLATE",compressionOptions:{level:6}}),g=(d.length/1024/1024).toFixed(2);e.dispatchEvent(new CustomEvent("syncProgress",{detail:{message:`Zip created for ${c} (${g} MB).`,type:"info"}}));const f=Math.ceil(d.length/i);for(const p of n){if(e.isSyncCancelled)throw new Error("Sync cancelled by user.");const y=e.sync.peerConnections.get(p);if(!y||!y.dataChannel||y.dataChannel.readyState!=="open"){const w=`Error: Cannot send files to ${p.substring(0,8)}... No open data channel.`;console.error(w),e.dispatchEvent(new CustomEvent("syncProgress",{detail:{message:w,type:"error"}}));continue}const v=y.dataChannel;e.dispatchEvent(new CustomEvent("syncProgress",{detail:{message:`Sending ${c} to ${p.substring(0,8)}...`,type:"info"}}));for(let w=0;w<f;w++){if(e.isSyncCancelled)throw new Error("Sync cancelled by user.");await r(v);const S=w*i,E=Math.min(S+i,d.length),$=d.slice(S,E);e.sync.sendSyncMessage({type:"garden_zip_chunk",gardenName:c,transferId:s,chunkIndex:w,totalChunks:f,data:Buffer.from($).toString("base64"),zipSize:d.length},p),((w+1)%10===0||w+1===f)&&e.dispatchEvent(new CustomEvent("syncProgress",{detail:{message:`Sent ${w+1} of ${f} chunks for ${c} to ${p.substring(0,8)}...`,type:"info"}}))}e.sync.sendSyncMessage({type:"garden_zip_complete",gardenName:c,transferId:s},p),e.dispatchEvent(new CustomEvent("syncProgress",{detail:{message:`Finished sending ${c} to ${p.substring(0,8)}.`,type:"info"}}))}}for(const c of n)e.sync.sendSyncMessage({type:"full_sync_complete"},c);e.dispatchEvent(new CustomEvent("syncProgress",{detail:{message:"All selected gardens sent successfully.",type:"complete",action:"send"}}))}catch(c){c.message.includes("cancelled")?e.dispatchEvent(new CustomEvent("syncProgress",{detail:{message:"Sync cancelled by user.",type:"cancelled"}})):(console.error("Error handling garden send/request:",c),e.dispatchEvent(new CustomEvent("syncProgress",{detail:{message:`Error: ${c.message}`,type:"error"}})))}}static async getAllFilesIncludingGit(e,t){let n=[];try{const s=await e.readdir(t);for(const i of s){const o=`${t==="/"?"":t}/${i}`;try{(await e.stat(o)).isDirectory()?n=n.concat(await this.getAllFilesIncludingGit(e,o)):n.push(o)}catch(r){C.warn(`Could not stat ${o}, skipping.`,r)}}}catch(s){C.log(`Directory not readable: ${t}`,s)}return n}static async handleGardenZipChunk(e,t){if(e.isSyncCancelled||e.currentTransferId!==t.transferId)return;e.activeTransfers||(e.activeTransfers=new Map);const n=`${t.gardenName}-${t.transferId}`;e.activeTransfers.has(n)||(e.activeTransfers.set(n,{chunks:new Array(t.totalChunks),receivedCount:0,totalChunks:t.totalChunks,gardenName:t.gardenName,zipSize:t.zipSize}),e.dispatchEvent(new CustomEvent("syncProgress",{detail:{message:`Receiving ${t.gardenName} (${(t.zipSize/1024/1024).toFixed(2)} MB)...`,type:"info"}})));const s=e.activeTransfers.get(n);s.chunks[t.chunkIndex]=Buffer.from(t.data,"base64"),s.receivedCount++,(s.receivedCount%10===0||s.receivedCount===s.totalChunks)&&e.dispatchEvent(new CustomEvent("syncProgress",{detail:{message:`Received ${s.receivedCount} of ${s.totalChunks} chunks for ${t.gardenName}...`,type:"info"}}))}static async handleGardenZipComplete(e,t){if(e.isSyncCancelled)return;const n=`${t.gardenName}-${t.transferId}`,s=e.activeTransfers.get(n);if(s){if(s.receivedCount!==s.totalChunks){e.dispatchEvent(new CustomEvent("syncProgress",{detail:{message:`Error: Missing chunks for ${t.gardenName}`,type:"error"}})),e.activeTransfers.delete(n);return}try{e.dispatchEvent(new CustomEvent("syncProgress",{detail:{message:`Reassembling and extracting ${t.gardenName}...`,type:"info"}}));const i=s.chunks.reduce((d,g)=>d+g.length,0),o=new Uint8Array(i);let r=0;for(const d of s.chunks)o.set(d,r),r+=d.length;const c=await K.loadAsync(o),l=new k(t.gardenName);await l.initRepo(),e.dispatchEvent(new CustomEvent("syncProgress",{detail:{message:`Clearing existing data for ${t.gardenName}...`,type:"info"}})),await l.rmrf("/.git"),await l.clearWorkdir();const h=Object.entries(c.files);let u=0;for(const[d,g]of h)if(!g.dir){const f=await g.async("uint8array"),p=`/${d}`,y=p.substring(0,p.lastIndexOf("/"));y&&y!=="/"&&await l.ensureDir(y),await l.pfs.writeFile(p,f),u++}e.dispatchEvent(new CustomEvent("syncProgress",{detail:{message:`Successfully extracted ${t.gardenName} (${u} files).`,type:"complete"}})),e.activeTransfers.delete(n),e.activeTransfers.size===0&&e.markSyncStreamAsComplete()}catch(i){console.error(`Error extracting garden ${t.gardenName}:`,i),e.dispatchEvent(new CustomEvent("syncProgress",{detail:{message:`Error extracting ${t.gardenName}: ${i.message}`,type:"error"}})),e.activeTransfers.delete(n)}}}}class Te{static async sendGardensToPeers(e,t){e.dispatchEvent(new CustomEvent("syncProgress",{detail:{message:"Initiating send process...",type:"info"}})),await at.sendGardens(e,t.gardens,t.peers)}static requestSpecificGardens(e,t){e.dispatchEvent(new CustomEvent("syncProgress",{detail:{message:"Requesting selected gardens from peers...",type:"info"}}));const n=e.sync.signaling.peerId;if(!n){const s="Cannot request gardens: own peer ID is not available.";e.dispatchEvent(new CustomEvent("syncProgress",{detail:{message:s,type:"error"}})),console.error(s);return}Object.entries(t).forEach(([s,i])=>{const o=s.substring(0,8);e.dispatchEvent(new CustomEvent("syncProgress",{detail:{message:`Sending request to peer ${o}... for gardens: ${i.join(", ")}`,type:"info"}})),e.sync.sendSyncMessage({type:"request_gardens",gardens:i,requesterId:n},s)}),e.sync.addMessage(`Sent requests for ${Object.keys(t).length} peer(s).`)}static sendFileUpdate(e,t,n,s){e.sync.sendSyncMessage({type:"file_update",path:t,content:n,timestamp:s})}}class Fs extends Ns{constructor(e){super(),this.sync=e,this.gitClient=null,this.pendingWriteCount=0,this.isSyncCompleteMessageReceived=!1,this.deletedGitDirs=new Set,this.isSyncFailed=!1,this.isSyncCancelled=!1,this.activeTransfers=new Map,this.currentTransferId=null,this.targetPeers=[]}resetFullSyncState(){this.pendingWriteCount=0,this.isSyncCompleteMessageReceived=!1,this.deletedGitDirs.clear(),this.activeTransfers.clear(),this.isSyncFailed=!1,this.isSyncCancelled=!1,this.currentTransferId=null,this.targetPeers=[]}_getGitClient(){return Ms.getGitClient(this)}setGitClient(e){this.gitClient=e}setupDataChannel(e){Rs.setupDataChannel(this,e)}async handleSyncMessage(e){if(!(this.isSyncCancelled&&e.type!=="sync_cancel"))try{await at.handleSyncMessage(this,e)}catch(t){console.error("[SyncFiles] Critical error handling sync message:",t),this.isSyncFailed=!0,this.dispatchEvent(new CustomEvent("syncProgress",{detail:{message:`A critical error occurred: ${t.message}. Aborting sync.`,type:"error"}}))}}async sendGardensToPeers(e){this.resetFullSyncState(),await Te.sendGardensToPeers(this,e)}requestSpecificGardens(e){this.resetFullSyncState(),Te.requestSpecificGardens(this,e)}cancelSync(e=!0){this.isSyncCancelled||(this.isSyncCancelled=!0,this.activeTransfers.clear(),e&&this.currentTransferId&&this.sync.sendSyncMessage({type:"sync_cancel",transferId:this.currentTransferId}),this.dispatchEvent(new CustomEvent("syncProgress",{detail:{message:"Sync cancelled by user.",type:"cancelled"}})))}incrementPendingWrites(){this.pendingWriteCount++}decrementPendingWrites(){this.pendingWriteCount--,this.checkForReload()}markSyncStreamAsComplete(){this.isSyncCompleteMessageReceived=!0,this.checkForReload()}checkForReload(){this.isSyncFailed||this.isSyncCancelled||this.isSyncCompleteMessageReceived&&this.pendingWriteCount===0&&this.activeTransfers.size===0&&(this.dispatchEvent(new CustomEvent("syncProgress",{detail:{message:"All files received and written. Reloading...",type:"complete",action:"receive"}})),setTimeout(()=>window.location.reload(),1500))}destroy(){super.destroy(),this.activeTransfers.clear()}async getAllFiles(e){return rt._listAllFiles(e,"/")}}class _s{constructor(e){this.sync=e,this.syncMethodIndicatorEl=null,this.syncProgressModal=null,this.syncProgressLogArea=null,this.syncProgressFinalMessageArea=null,this.syncProgressActionButton=null,this.connectBtn=null,this.nameInput=null,this.peerPrefixInput=null,this.autoConnectCheckbox=null}render(){this.sync._container&&(this.sync._container.innerHTML=`
  ...
  `}class Hs{constructor(e){this.eruda=e,this._$el=null}add(){this.eruda.add({name:"Data",init:e=>{this._$el=e,this._render(),this._bindEvents()},show:()=>this._$el.show(),hide:()=>this._$el.hide()})}_render(){this._$el.html(`
      <div>
    ...
    `)}_bindEvents(){const e=this._$el;e.find("#export-btn")[0].addEventListener("click",()=>this._handleExport()),e.find("#import-btn")[0].addEventListener("click",()=>e.find("#import-file-input")[0].click()),e.find("#import-file-input")[0].addEventListener("change",t=>this._handleFileSelect(t)),e.find("#clear-data-btn")[0].addEventListener("click",()=>this._handleClearData()),e.find("#reset-settings-btn")[0].addEventListener("click",()=>this._handleResetSettings()),e.find("#update-app-btn")[0].addEventListener("click",()=>this._handleAppUpdate())}_handleAppUpdate(){const e=window.thoughtform.updateApp;if(!e){const i=new b({title:"Error"});i.updateContent("<p>Update check function is not available. The PWA module may not have loaded correctly.</p>"),i.addFooterButton("Close",()=>i.destroy()),i.show();return}const t=new b({title:"Checking for Updates..."});t.updateContent("<p>Contacting server for the latest version...</p>"),t.show();let n=!1;const s=e.onNeedRefresh;s&&(e.onNeedRefresh=()=>{n=!0,t.destroy(),s()}),e(),setTimeout(()=>{n||(t.updateContent("<p>No new update found. You are on the latest version.</p>"),t.clearFooter(),t.addFooterButton("Close",()=>t.destroy())),e.onNeedRefresh!==s&&(e.onNeedRefresh=s)},5e3)}async _handleResetSettings(){if(!await b.confirm({title:"Reset Default Settings?",message:"This will overwrite the default configuration and hook files in your 'Settings' garden with the latest versions from the application. <br><br><strong>Your custom scripts and other files will not be affected.</strong>",okText:"Reset Files"}))return;const t=new b({title:"Restoring Settings..."});let n="";const s=i=>{console.log(`[Settings Reset] ${i}`),n+=`<div>${i}</div>`,t.updateContent(`<div style="font-family: monospace; max-height: 300px; overflow-y: auto;">${n}</div>`)};t.show(),await qs(s)}_handleExport(){const e=localStorage.getItem("thoughtform_gardens"),t=e?JSON.parse(e):["home"],n=new b({title:"Select Gardens to Export"});n.updateContent(ie("Choose which gardens to include in the export:",t));const s=n.content;s.querySelector(".select-all-btn").onclick=()=>s.querySelectorAll(".garden-select-checkbox").forEach(o=>o.checked=!0),s.querySelector(".select-none-btn").onclick=()=>s.querySelectorAll(".garden-select-checkbox").forEach(o=>o.checked=!1);const i=async()=>{const o=Array.from(s.querySelectorAll(".garden-select-checkbox:checked")).map(h=>h.value);n.destroy();const r=new b({title:"Exporting Gardens..."});r.updateContent("<p>Preparing export. Please wait...</p>");let c=!1,l="";r.addFooterButton("Cancel",()=>{c=!0,r.destroy()}),r.show();try{await Os(o,h=>{if(c)throw new Error("Export cancelled by user.");l+=h+"<br>",r.updateContent(`<div style="font-family: monospace; max-height: 300px; overflow-y: auto;">${l}</div>`)}),c||(r.clearFooter(),r.updateContent("<p>Export complete! The download will begin shortly.</p>"),setTimeout(()=>r.destroy(),3e3))}catch(h){c||(r.clearFooter(),r.updateContent(`<p style="color: #F44747;"><strong>Export Failed</strong><br>${h.message}</p>`),r.addFooterButton("Close",()=>r.destroy()))}};n.addFooterButton("Export Selected",i),n.addFooterButton("Cancel",()=>n.destroy()),n.show()}async _handleFileSelect(e){const t=e.target,n=t.files[0];if(!n)return;const s=new b({title:"Select Gardens to Import"});s.updateContent("Scanning zip file..."),s.show();try{const i=await Gs(n);if(i.length===0){s.updateContent("No valid gardens found in this zip file."),s.addFooterButton("Close",()=>s.destroy());return}s.updateContent(ie(`Found ${i.length} garden(s). Select which to import:`,i));const o=s.content;o.querySelector(".select-all-btn").onclick=()=>o.querySelectorAll(".garden-select-checkbox").forEach(c=>c.checked=!0),o.querySelector(".select-none-btn").onclick=()=>o.querySelectorAll(".garden-select-checkbox").forEach(c=>c.checked=!1);const r=async()=>{const c=Array.from(o.querySelectorAll(".garden-select-checkbox:checked")).map(h=>h.value);s.clearFooter(),s.updateContent("Starting import...");let l="";try{await Bs(n,c,h=>{l+=`${h}<br>`,s.updateContent(l)})}catch(h){s.updateContent(`<strong>Error during import:</strong><br>${h.message}`),s.addFooterButton("Close",()=>s.destroy())}};s.addFooterButton("Import Selected",r),s.addFooterButton("Cancel",()=>s.destroy())}catch(i){s.updateContent(`<strong>Error:</strong> Could not read the zip file.<br>${i.message}`),s.addFooterButton("Close",()=>s.destroy())}finally{t.value=""}}_handleClearData(){const e=localStorage.getItem("thoughtform_gardens"),t=e?JSON.parse(e):[],n=new b({title:"Clear Garden Data"});n.updateContent(ie("Select gardens to permanently delete:",t,!1));const s=n.content;s.querySelector(".select-all-btn").onclick=()=>s.querySelectorAll(".garden-select-checkbox").forEach(r=>r.checked=!0),s.querySelector(".select-none-btn").onclick=()=>s.querySelectorAll(".garden-select-checkbox").forEach(r=>r.checked=!1);const i=async()=>{const r=Array.from(s.querySelectorAll(".garden-select-checkbox:checked")).map(l=>l.value);n.clearFooter(),n.updateContent("Starting deletion...");let c="";try{await Us(r,l=>{c+=`${l}<br>`,n.updateContent(c)})}catch(l){n.updateContent(`<strong>Error during deletion:</strong><br>${l.message}`),n.addFooterButton("Close",()=>n.destroy()).classList.add("destructive")}};n.addFooterButton("Delete Selected",i).classList.add("destructive"),n.addFooterButton("Cancel",()=>n.destroy()),n.show()}}function js(a){new Hs(a).add()}class zs{constructor(e){this.eruda=e,this._$el=null}add(){this.eruda.add({name:"AI",init:e=>{this._$el=e,this._render(),this._bindEvents()},show:()=>this._$el.show(),hide:()=>this._$el.hide()})}_render(){this._$el.html(`
...
`),o=this.query.toLowerCase();let r=i.find(l=>l.toLowerCase().includes(o));r||(r=i.find(l=>l.trim()!=="")||"No content preview available.");const c=new RegExp(this.query.replace(/[-/\\^$*+?.()|[\]{}]/g,"\\$&"),"gi");return r.trim().replace(c,"<mark>$&</mark>")}catch{return"Could not load file preview."}}async renderResults(){if(this.resultsList.innerHTML="",this.results.length===0){this.resultsList.innerHTML=`<li class="command-no-results">${this.isIndexing?"Indexing...":"No matches found"}</li>`;return}const e=document.createDocumentFragment();for(let t=0;t<this.results.length;t++){const n=this.results[t].doc,s=document.createElement("li");s.className="command-result-item",s.dataset.index=t;const i=n.path.startsWith("/")?n.path.substring(1):n.path,o=` <span class="command-garden">[${n.garden}]</span>`;if(this.mode==="searchContent"){const r=await this.getSnippet(n.garden,n.path);s.innerHTML=`
            ...
            `}else s.innerHTML=`<div class="command-path">${o} ${i}</div>`;t===this.selectedIndex&&(s.classList.add("active"),s.scrollIntoView({block:"nearest"})),e.appendChild(s)}this.resultsList.appendChild(e)}async selectItem(e){if(e<0||e>=this.results.length)return;const t=this.results[e].doc;if(this.mode==="executeCommand"){const n=window.thoughtform.workspace.getActiveEditor(),s=await window.thoughtform.workspace.getActiveGitClient();if(n&&s){const i=`${t.garden}#${t.path}`;ee(i,n,s)}}else window.thoughtform.workspace.openFile(t.garden,t.path);this.close()}async insertLink(e){if(e<0||e>=this.results.length||!this.lastEditorState)return;const{editor:t,selection:n}=this.lastEditorState;if(!t||!t.editorView||t.editorView.isDestroyed)return;const s=this.results[e].doc,i=t.gitClient.gardenName,o=s.path.startsWith("/")?s.path.substring(1):s.path;let r;s.garden===i?r=o:r=`${s.garden}#${o}`;const c=`[[${r}]]`;t.editorView.dispatch({changes:{from:n.from,to:n.to,insert:c},selection:{anchor:n.from+c.length}}),this.close()}async openInNewPane(e){if(e<0||e>=this.results.length||!this.lastEditorState)return;const{editor:t}=this.lastEditorState;if(!t||!t.paneId){console.error("[CommandPalette] Cannot open in new pane, source editor or paneId not found.");return}const n=this.results[e].doc,s=t.gitClient.gardenName,i=n.path.startsWith("/")?n.path.substring(1):n.path;let o;n.garden===s?o=i:o=`${n.garden}#${i}`,window.thoughtform.workspace.openInNewPane(o,t.paneId),this.close()}handleInput(e){this.search(e.target.value)}async handleResultClick(e){const t=e.target.closest(".command-result-item");t&&await this.selectItem(parseInt(t.dataset.index,10))}async handleKeyDown(e){if(this.isOpen)switch(e.key){case"ArrowDown":e.preventDefault(),this.selectedIndex=(this.selectedIndex+1)%this.results.length,this.renderResults();break;case"ArrowUp":e.preventDefault(),this.selectedIndex=(this.selectedIndex-1+this.results.length)%this.results.length,this.renderResults();break;case"Enter":e.preventDefault(),this.results.length>0&&(e.shiftKey&&(e.ctrlKey||e.metaKey)&&this.mode!=="executeCommand"?await this.openInNewPane(this.selectedIndex):(e.ctrlKey||e.metaKey)&&this.mode!=="executeCommand"?await this.insertLink(this.selectedIndex):await this.selectItem(this.selectedIndex));break;case"Escape":e.preventDefault(),this.close();break}}}async function dt(a,e){const t=a.pfs;let n=[];try{const s=await t.readdir(e);for(const i of s){if(i===".git")continue;const o=`${e==="/"?"":e}/${i}`;try{(await t.stat(o)).isDirectory()?n=n.concat(await dt(a,o)):n.push(o)}catch{console.warn(`[Migration] Could not stat ${o}, skipping.`)}}}catch{console.warn(`[Migration] Could not read directory: ${e}.`)}return n}async function Ys(){console.log("%cStarting Thoughtform data migration...","font-weight: bold; font-size: 1.2em;"),console.log("This will convert all files from the old JSON format to raw content. This only needs to be run once.");const a=localStorage.getItem("thoughtform_gardens"),e=a?JSON.parse(a):["home"];if(e.length===0){console.log("No gardens found to migrate.");return}let t=0,n=0;for(const s of e){console.log(`%cProcessing garden: "${s}"`,"font-weight: bold; color: blue;");const i=new k(s),o=await dt(i,"/");if(o.length===0){console.log("No files found in this garden.");continue}for(const r of o){t++;try{const c=await i.readFile(r);let l;try{l=JSON.parse(c)}catch{console.log(`- ${r} is not in JSON format, skipping.`);continue}if(l&&typeof l.content<"u"){const h=l.content;c!==h?(console.log(`%c  MIGRATING: ${r}`,"color: green;"),await i.writeFile(r,h),n++):console.log(`- ${r} content is already raw, skipping.`)}else console.log(`- ${r} is valid JSON but not the old format, skipping.`)}catch(c){console.error(`%c  ERROR: Failed to process ${r}.`,"color: red;",c)}}}console.log("%cMigration complete!","font-weight: bold; font-size: 1.2em;"),console.log(`Checked ${t} files across ${e.length} garden(s).`),console.log(`Migrated ${n} files.`),console.log("You should now refresh the page.")}async function Ie(a,e,t,n){const s=`https://generativelanguage.googleapis.com/v1beta/models/${e}:streamGenerateContent?key=${a}&alt=sse`,i={contents:[{parts:[{text:t}]}]};try{const o=await fetch(s,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(i),signal:n});if(!o.ok){const l=await o.json();throw console.error("Gemini API Error:",l),new Error(`API request failed: ${l.error?.message||o.statusText}`)}const r=o.body.getReader(),c=new TextDecoder;return new ReadableStream({async pull(l){for(;;){const{done:h,value:u}=await r.read();if(h){l.close();break}const g=c.decode(u,{stream:!0}).split(`
`);for(const f of g)if(f.startsWith("data: "))try{const p=f.substring(5).trim(),v=JSON.parse(p)?.candidates?.[0]?.content?.parts?.[0]?.text;v&&l.enqueue(v)}catch{}}}})}catch(o){throw o.name==="AbortError"?console.log("Gemini API request was cancelled by the user."):console.error("Failed to fetch from Gemini API:",o),o}}class Xs{constructor(e){if(!e)throw new Error("Traversal helper requires a gitClient instance.");this.gitClient=e}extractWikilinks(e){const t=/\[\[([^\[\]]+?)\]\]/g,n=new Set;let s;for(;s=t.exec(e);){const i=s[1].split("|")[0].trim();n.add(i)}return Array.from(n)}async readLinkContent(e,t){let n=t,s=e;const i=e.match(/^([^#]+)#(.*)$/);i&&(n=i[1],s=i[2]),s.startsWith("/")||(s=`/${s}`);const o=n!==this.gitClient.gardenName?new k(n):this.gitClient,r=n!==this.gitClient.gardenName?`${n}#${s}`:s;try{return{content:await o.readFile(s),fullIdentifier:r,gardenName:n}}catch(c){return console.warn(`[Agent] Handled a broken link. Could not read ${r}:`,c.message),{content:null,fullIdentifier:r,gardenName:null}}}}const oe=new Map,ht=new Map(fe.filter(([a])=>a.startsWith("/settings/tools/")).map(([a,e])=>[a,e]));function Zs(a){const e=/\/\*[\s\S]*?\*\/|\/\/.*/g,t=a.match(e);return t?t.join(`
`).replace(/^\s*\/\*+\s*?/gm,"").replace(/^\s*\*+\/\s*?$/gm,"").replace(/\*\/$/,"").replace(/^\s*\*\s?/gm,"").replace(/^\s*\/\/\s?/gm,"").trim():""}async function Qs(a,e){const t=`${e}#${a}`;if(oe.has(t))return oe.get(t);let n,s=e;try{n=await new k(e).readFile(a)}catch(i){if(!i.message.includes("does not exist"))throw i;try{s="Settings",n=await new k(s).readFile(a)}catch(o){if(!o.message.includes("does not exist"))throw o;n=ht.get(a),s="Default"}}if(!n)return null;try{const i=a.split("/").pop().replace(".js",""),o=Zs(n),r=new Function("args","context",`
      return (async () => {
        try { 
          ${n} 
        } catch (e) {
