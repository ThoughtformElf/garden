...
import{X as J,A as lt,t as v,Y as Fe,Z as re,_ as de,$ as Y,a0 as dt,a1 as ht,a2 as ut}from"./chunk-vendor.js";import{F as gt,g as A,i as ke}from"./chunk-git.js";import{S as ft,s as pt,m as mt,L as ee,j as De,h as Oe,c as Ue,a as wt,y as yt,x as vt,b as bt,d as Ct,e as Ge,C as z,k as j,E as D,H as St,f as me,D as $,V as M,R,g as K,W as Be,i as we,l as qe,n as kt,o as Et,p as xt,q as Tt,r as Pt,t as It,u as $t,v as Lt,w as At,z as Nt,A as Mt,B as Rt,F as _t,G as Ft,I as Dt,J as ze,K as Ot,M as Ut,N as Gt,O as Bt,P as qt,Q as zt,T as Ht,U as Wt,X as jt,Y as Kt}from"./chunk-codemirror.js";import{c as X}from"./chunk-gpt-tokenizer.js";import{e as q}from"./chunk-eruda.js";(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const s of document.querySelectorAll('link[rel="modulepreload"]'))n(s);new MutationObserver(s=>{for(const i of s)if(i.type==="childList")for(const o of i.addedNodes)o.tagName==="LINK"&&o.rel==="modulepreload"&&n(o)}).observe(document,{childList:!0,subtree:!0});function t(s){const i={};return s.integrity&&(i.integrity=s.integrity),s.referrerPolicy&&(i.referrerPolicy=s.referrerPolicy),s.crossOrigin==="use-credentials"?i.credentials="include":s.crossOrigin==="anonymous"?i.credentials="omit":i.credentials="same-origin",i}function n(s){if(s.ep)return;s.ep=!0;const i=t(s);fetch(s.href,i)}})();var He=!1;try{var ae={};Object.defineProperty(ae,"passive",{get(){return He=!0,!1}}),window.addEventListener("testpassive",null,ae),window.removeEventListener("testpassive",null,ae)}catch{}if(He){var Vt=EventTarget.prototype.addEventListener;EventTarget.prototype.addEventListener=function(a,e,t){var n=t&&typeof t=="object",s=n?t.capture:t,i=n?Object.assign({},t):{};return i.passive===void 0&&(a==="touchstart"||a==="touchmove"||a==="wheel")&&(i.passive=!0),i.capture===void 0&&(i.capture=!!s),Vt.call(this,a,e,i)}}class Ee{constructor({targetSelector:e,items:t,containerItems:n=[],itemSelector:s,dataAttribute:i}){if(this.targetSelector=e,this.items=t,this.containerItems=n,this.itemSelector=s,i){const o=i.replace("data-","");this.dataAttributeKey=o.replace(/-([a-z])/g,r=>r[1].toUpperCase())}else this.dataAttributeKey=null;this.menuElement=null,this.longPressTimeout=null,this.boundHideMenu=this.hideMenu.bind(this),this.init()}init(){this.createMenuElement(),document.addEventListener("contextmenu",this.handleContextMenu.bind(this)),document.addEventListener("touchstart",this.handleTouchStart.bind(this),{passive:!1}),document.addEventListener("touchend",this.handleTouchEnd.bind(this)),document.addEventListener("touchcancel",this.handleTouchEnd.bind(this))}createMenuElement(){this.menuElement=document.createElement("div"),this.menuElement.className="context-menu",document.body.appendChild(this.menuElement)}handleContextMenu(e){const t=e.target.closest(this.targetSelector);if(!t)return;e.preventDefault();const n=this.itemSelector?e.target.closest(this.itemSelector):null;n?this.showMenu(e.clientX,e.clientY,this.items,n):this.showMenu(e.clientX,e.clientY,this.containerItems,t)}handleTouchStart(e){const t=e.target.closest(this.targetSelector);t&&(this.longPressTimeout=setTimeout(()=>{e.preventDefault();const n=this.itemSelector?e.target.closest(this.itemSelector):null,s=n?this.items:this.containerItems;this.showMenu(e.touches[0].clientX,e.touches[0].clientY,s,n||t),this.longPressTimeout=null},500))}handleTouchEnd(){this.longPressTimeout&&(clearTimeout(this.longPressTimeout),this.longPressTimeout=null)}showMenu(e,t,n,s){this.menuElement.innerHTML="",this.menuElement.style.display="block";const i=this.dataAttributeKey&&s.dataset[this.dataAttributeKey]?s.dataset[this.dataAttributeKey]:null;n.forEach(u=>{if(u.type==="separator"){const f=document.createElement("div");f.className="context-menu-separator",this.menuElement.appendChild(f);return}const g=document.createElement("button");g.className="context-menu-item",g.textContent=u.label,g.addEventListener("click",()=>{u.action(i),this.hideMenu()}),this.menuElement.appendChild(g)});const o=this.menuElement.offsetWidth,r=this.menuElement.offsetHeight,{innerWidth:c,innerHeight:l}=window;let d=e,h=t;e+o>c&&(d=c-o-5),t+r>l&&(h=l-r-5),this.menuElement.style.top=`${h}px`,this.menuElement.style.left=`${d}px`,document.addEventListener("click",this.boundHideMenu),document.addEventListener("contextmenu",this.boundHideMenu)}hideMenu(e){e&&this.menuElement.contains(e.target)||this.menuElement.style.display==="block"&&(this.menuElement.style.display="none",document.removeEventListener("click",this.boundHideMenu),document.removeEventListener("contextmenu",this.boundHideMenu))}}class S{constructor({title:e="Notice"}={}){this.overlay=document.createElement("div"),this.overlay.className="modal-overlay hidden",this.container=document.createElement("div"),this.container.className="modal-container",this.header=document.createElement("div"),this.header.className="modal-header",this.header.textContent=e,this.content=document.createElement("div"),this.content.className="modal-content",this.content.innerHTML="Loading...",this.footer=document.createElement("div"),this.footer.className="modal-footer",this.footer.style.display="none",this.container.appendChild(this.header),this.container.appendChild(this.content),this.container.appendChild(this.footer),this.overlay.appendChild(this.container),document.body.appendChild(this.overlay)}show(){this.overlay.classList.remove("hidden")}hide(){this.overlay.classList.add("hidden")}destroy(){this.overlay.parentNode&&this.overlay.remove()}updateContent(e){this.content.innerHTML=e}addFooterButton(e,t){this.footer.style.display="flex";const n=document.createElement("button");return n.textContent=e,n.addEventListener("click",t),this.footer.appendChild(n),n}clearFooter(){this.footer.innerHTML="",this.footer.style.display="none"}static prompt({title:e,label:t,defaultValue:n=""}){return new Promise(s=>{const i=new S({title:e}),o=`modal-input-${Date.now()}`,r=`
      ...
      `;i.updateContent(r);const c=i.content.querySelector(`#${o}`),l=()=>{s(c.value),i.destroy()},d=()=>{s(null),i.destroy()};c.addEventListener("keydown",h=>{h.key==="Enter"?(h.preventDefault(),l()):h.key==="Escape"&&d()}),i.addFooterButton("OK",l),i.addFooterButton("Cancel",d),i.show(),c.focus(),c.select()})}static confirm({title:e,message:t,okText:n="OK",cancelText:s="Cancel",destructive:i=!1}){return new Promise(o=>{const r=new S({title:e});r.updateContent(`<p>${t}</p>`);const c=()=>{o(!0),r.destroy()},l=()=>{o(!1),r.destroy()},d=r.addFooterButton(n,c);i&&d.classList.add("destructive"),r.addFooterButton(s,l),r.show()})}static choice({title:e,message:t,choices:n}){return new Promise(s=>{const i=new S({title:e});i.updateContent(t),n.forEach(r=>{const c=i.addFooterButton(r.text,()=>{s(r.id),i.destroy()});r.class&&c.classList.add(r.class)});const o=r=>{r.key==="Escape"&&(s(null),i.destroy(),document.removeEventListener("keydown",o))};document.addEventListener("keydown",o),i.show()})}static selection({title:e,peerData:t,okText:n="Request"}){return new Promise(s=>{if(t.size===0){const l=new S({title:"No Peers Found"});l.updateContent("<p>There are no other peers currently connected to this sync session.</p>"),l.addFooterButton("OK",()=>{l.destroy(),s(null)}),l.show();return}const i=new S({title:e});let o='<div class="peer-selection-container">';t.forEach((l,d)=>{o+=`
        ...
        `},c=Array.from(t.values());let l='<div class="modal-send-container">';l+=r("Gardens to Send",n),l+=r("Peers to Receive",c,!0),l+="</div>",o.updateContent(l),o.content.querySelectorAll(".modal-selection-group").forEach(u=>{u.querySelector(".select-all-btn").onclick=()=>u.querySelectorAll(".modal-select-checkbox").forEach(g=>g.checked=!0),u.querySelector(".select-none-btn").onclick=()=>u.querySelectorAll(".modal-select-checkbox").forEach(g=>g.checked=!1)});const d=()=>{const u=Array.from(o.content.querySelectorAll("#group-GardenstoSend .modal-select-checkbox:checked")).map(f=>f.value),g=Array.from(o.content.querySelectorAll("#group-PeerstoReceive .modal-select-checkbox:checked")).map(f=>f.value);u.length>0&&g.length>0?i({gardens:u,peers:g}):i(null),o.destroy()},h=()=>{i(null),o.destroy()};o.addFooterButton(s,d),o.addFooterButton("Cancel",h),o.show()})}}function Jt(a){const e={};a.sort((t,n)=>t.path.localeCompare(n.path));for(const{path:t,isDirectory:n}of a){const s=t.substring(1).split("/");let i=e;for(let o=0;o<s.length;o++){const r=s[o];o===s.length-1?i[r]||(i[r]=n?{type:"folder",path:t,children:{}}:{type:"file",path:t}):(i[r]||(i[r]={type:"folder",path:"/"+s.slice(0,o+1).join("/"),children:{}}),i[r].children||(i[r].children={}),i=i[r].children)}}return e}function We(a,e,t,n,s){const i=Object.keys(a).sort((r,c)=>{const l=a[r],d=a[c];return l.type==="folder"&&d.type!=="folder"?-1:l.type!=="folder"&&d.type==="folder"?1:r.localeCompare(c,void 0,{numeric:!0})});let o="";for(const r of i){const c=a[r],l=`padding-left: ${s*20}px;`;if(c.type==="folder"){const d=n.has(c.path);o+=`
...
# Concise Summary:`;i(`Generating summary of oldest ${x} steps...`);const P=await n.getCompletionAsString(T,null,s);i("Memory compression complete.");const _=`${p}
- ${P.trim()}`.replace(f,"").trim();return`${u}
...
INITIAL CONTEXT:
${this.initialContext}
---`,i=0,o=!1,r=0,c=0;const l=new Set,d=({input:y,output:w})=>{r+=y,c+=w},h={getCompletion:(y,w,m)=>this.aiService.getCompletion(y,b=>{d(b),w&&w(b)},m||n),getCompletionAsString:(y,w,m)=>this.aiService.getCompletionAsString(y,b=>{d(b),w&&w(b)},m||n)},u={Traversal:Si,Git:E};for(;!o;){if(i++,n.aborted)throw new DOMException("Agent run was cancelled by the user.","AbortError");const y=Array.from(this.tools.values()).map(L=>`- ${L.name}: ${L.description}`).join(`
`),w=this._fillPrompt(Ke,{scratchpad:s,tool_list:y}),m={input:r,output:c};let b;try{b=(await this._getJsonCompletion(w,h,n)).responseJson}catch(L){if(L.name==="AbortError")throw L;const W=L.message;this._sendStreamEvent(t,"status","An error occurred during planning. Analyzing...");const Se=await this._classifyError(W,h,n);switch(this._sendStreamEvent(t,"status",`Error classified as: ${Se}`),Se){case"CONTEXT_OVERFLOW":s+=`
...
[Total: ${r.toLocaleString()} in / ${c.toLocaleString()} out]`);const T=b.thought,P=b.action;if(this._sendStreamEvent(t,"thought",T),s+=`
THOUGHT: ${T}`,!P||!P.tool||!this.tools.has(P.tool)){this._sendStreamEvent(t,"status",`Error: AI chose an invalid tool ('${P.tool}'). Retrying.`),s+=`
OBSERVATION: The last tool choice ('${P.tool}') was invalid. I must choose a tool from the provided list.`;continue}if(P.tool==="finish"){o=!0,s+=`
ASSESSMENT: The goal is met. I will now synthesize the final answer.`;continue}const _=P.tool,N=P.args||{};this._sendStreamEvent(t,"action",`Using tool \`${_}\` with args: ${JSON.stringify(N)}`);const U=this.tools.get(_),G={git:this.gitClient,ai:h,dependencies:u,onProgress:L=>this._sendStreamEvent(t,"status",L),signal:n,addSource:L=>{L&&typeof L=="string"&&l.add(L)}},Z={input:r,output:c};let O=await U.execute(N,G);if(_==="requestMemoryCompression")try{const L=JSON.parse(O);if(L.action==="request_memory_compression"){s=await this._compressScratchpad(s,L.details.errorMessage,h,n,W=>this._sendStreamEvent(t,"status",W));continue}}catch{}const B=String(O),Q=X(B),ie=Q>250?`[Observation received (${Q.toLocaleString()} tokens) and added to context.]`:B;this._sendStreamEvent(t,"observation",ie);const oe=r-Z.input,V=c-Z.output;(oe>0||V>0)&&this._sendStreamEvent(t,"status",`Tool LLM Usage:
...
OBSERVATION: ${B}
---`}this._sendStreamEvent(t,"status","Agent has finished its work. Synthesizing final answer...");const g=this._fillPrompt(Ve,{goal:e,context_buffer:s}),p=(await h.getCompletion(g)).getReader();for(;;){const{done:y,value:w}=await p.read();if(y)break;t.enqueue(w)}l.size>0&&t.enqueue(`
<!-- Sources: ${Array.from(l).join(", ")} -->`),t.enqueue(`
<!-- Total Tokens: ${r.toLocaleString()} in / ${c.toLocaleString()} out -->`),t.close()}}class Pi{constructor(){this.config={activeProvider:"gemini",geminiApiKey:"",geminiModelName:"gemini-2.5-flash",providers:[]},this.activeAgentControllers=new Map,this.loadConfig()}loadConfig(){this.config.activeProvider=localStorage.getItem("thoughtform_ai_provider")||"gemini",this.config.geminiApiKey=localStorage.getItem("thoughtform_gemini_api_key")||"",this.config.geminiModelName=localStorage.getItem("thoughtform_gemini_model_name")||"gemini-2.5-flash",this.config.providers=JSON.parse(localStorage.getItem("thoughtform_ai_providers_list")||"[]")}async getCompletion(e,t,n){let s,i=this.config.activeProvider;if(this.config.override_activeProvider&&(i=this.config.override_activeProvider),i==="gemini"){if(!this.config.geminiApiKey)throw new Error("Active provider is Gemini, but the API key is not set. Add it in DevTools > AI.");s=bi(this.config.geminiApiKey,this.config.geminiModelName,e,n)}else{const d=this.config.providers.find(f=>f.id===i);if(!d)throw new Error(`AI provider "${i}" not found. Please configure it in DevTools > AI.`);const h=this.config.override_customModelName||d.model,u=this.config.override_customEndpointUrl||d.endpoint||"http://localhost:11434/v1",g=this.config.override_customApiKey||d.apiKey;if(!h)throw new Error(`Provider "${i}" has no Model Name configured. This is a required field.`);s=Ci(u,g,h,e,n)}const o=await s;if(!t)return o;const r=X(e);let c="";const l=new TransformStream({transform(d,h){c+=d,h.enqueue(d)},flush(d){const h=X(c);t({input:r,output:h})}});return o.pipeThrough(l)}async getCompletionAsString(e,t,n){const i=(await this.getCompletion(e,t,n)).getReader();let o="";for(;;){const{done:r,value:c}=await i.read();if(r)break;o+=c}return o}async handleAiChatRequest(e){let t=-1;const n="🤖 Thinking...";let s=null,i=-1,o=-1;try{const r=window.thoughtform.workspace.getActiveEditor();if(!r||!r.gitClient||!r.paneId)throw new Error("Cannot find active editor, gitClient, or paneId for agent.");if(s=r.paneId,this.activeAgentControllers.has(s))return;const c=new AbortController;this.activeAgentControllers.set(s,c);const l=e.state.selection.main.head,d=e.state.doc.lineAt(l);let h=d.number;for(;h>1&&e.state.doc.line(h-1).text.trim().startsWith(">$");)h--;let u=d.number;for(;u<e.state.doc.lines&&e.state.doc.line(u+1).text.trim().startsWith(">$");)u++;const g=e.state.doc.line(h).from,f=e.state.doc.line(u).to;let p=e.state.sliceDoc(g,f);p=p.split(`
...
<response>
`;e.dispatch({changes:{from:t,to:t+n.length,insert:P}});let _=!1;i=t+P.length,o=i;const N=/^\[(STATUS|THOUGHT|ACTION|OBSERVATION)\]\s(.*)/s;for(;;){const{done:G,value:Z}=await T.read();if(G)break;const O=Z,B=O.match(N);if(B){if(_)continue;const Q=B[1],ie=B[2].trim(),V=`${{STATUS:"> Status:",THOUGHT:"## Thought",ACTION:"## Action",OBSERVATION:"## Observation"}[Q]}
${ie}
