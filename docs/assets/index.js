...
import{X as J,A as lt,t as v,Y as Fe,Z as re,_ as de,$ as Y,a0 as dt,a1 as ht,a2 as ut}from"./chunk-vendor.js";import{F as gt,g as A,i as ke}from"./chunk-git.js";import{S as ft,s as pt,m as mt,L as ee,j as De,h as Oe,c as Ue,a as wt,y as yt,x as vt,b as bt,d as Ct,e as Ge,C as z,k as j,E as D,H as St,f as me,D as $,V as M,R,g as K,W as Be,i as we,l as qe,n as kt,o as Et,p as xt,q as Tt,r as It,t as Pt,u as $t,v as Lt,w as At,z as Nt,A as Mt,B as Rt,F as _t,G as Ft,I as Dt,J as ze,K as Ot,M as Ut,N as Gt,O as Bt,P as qt,Q as zt,T as Ht,U as Wt,X as jt,Y as Kt}from"./chunk-codemirror.js";import{c as X}from"./chunk-gpt-tokenizer.js";import{e as q}from"./chunk-eruda.js";(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const s of document.querySelectorAll('link[rel="modulepreload"]'))n(s);new MutationObserver(s=>{for(const i of s)if(i.type==="childList")for(const o of i.addedNodes)o.tagName==="LINK"&&o.rel==="modulepreload"&&n(o)}).observe(document,{childList:!0,subtree:!0});function t(s){const i={};return s.integrity&&(i.integrity=s.integrity),s.referrerPolicy&&(i.referrerPolicy=s.referrerPolicy),s.crossOrigin==="use-credentials"?i.credentials="include":s.crossOrigin==="anonymous"?i.credentials="omit":i.credentials="same-origin",i}function n(s){if(s.ep)return;s.ep=!0;const i=t(s);fetch(s.href,i)}})();var He=!1;try{var ae={};Object.defineProperty(ae,"passive",{get(){return He=!0,!1}}),window.addEventListener("testpassive",null,ae),window.removeEventListener("testpassive",null,ae)}catch{}if(He){var Vt=EventTarget.prototype.addEventListener;EventTarget.prototype.addEventListener=function(a,e,t){var n=t&&typeof t=="object",s=n?t.capture:t,i=n?Object.assign({},t):{};return i.passive===void 0&&(a==="touchstart"||a==="touchmove"||a==="wheel")&&(i.passive=!0),i.capture===void 0&&(i.capture=!!s),Vt.call(this,a,e,i)}}class Ee{constructor({targetSelector:e,items:t,containerItems:n=[],itemSelector:s,dataAttribute:i}){if(this.targetSelector=e,this.items=t,this.containerItems=n,this.itemSelector=s,i){const o=i.replace("data-","");this.dataAttributeKey=o.replace(/-([a-z])/g,r=>r[1].toUpperCase())}else this.dataAttributeKey=null;this.menuElement=null,this.longPressTimeout=null,this.boundHideMenu=this.hideMenu.bind(this),this.init()}init(){this.createMenuElement(),document.addEventListener("contextmenu",this.handleContextMenu.bind(this)),document.addEventListener("touchstart",this.handleTouchStart.bind(this),{passive:!1}),document.addEventListener("touchend",this.handleTouchEnd.bind(this)),document.addEventListener("touchcancel",this.handleTouchEnd.bind(this))}createMenuElement(){this.menuElement=document.createElement("div"),this.menuElement.className="context-menu",document.body.appendChild(this.menuElement)}handleContextMenu(e){const t=e.target.closest(this.targetSelector);if(!t)return;e.preventDefault();const n=this.itemSelector?e.target.closest(this.itemSelector):null;n?this.showMenu(e.clientX,e.clientY,this.items,n):this.showMenu(e.clientX,e.clientY,this.containerItems,t)}handleTouchStart(e){const t=e.target.closest(this.targetSelector);t&&(this.longPressTimeout=setTimeout(()=>{e.preventDefault();const n=this.itemSelector?e.target.closest(this.itemSelector):null,s=n?this.items:this.containerItems;this.showMenu(e.touches[0].clientX,e.touches[0].clientY,s,n||t),this.longPressTimeout=null},500))}handleTouchEnd(){this.longPressTimeout&&(clearTimeout(this.longPressTimeout),this.longPressTimeout=null)}showMenu(e,t,n,s){this.menuElement.innerHTML="",this.menuElement.style.display="block";const i=this.dataAttributeKey&&s.dataset[this.dataAttributeKey]?s.dataset[this.dataAttributeKey]:null;n.forEach(u=>{if(u.type==="separator"){const f=document.createElement("div");f.className="context-menu-separator",this.menuElement.appendChild(f);return}const g=document.createElement("button");g.className="context-menu-item",g.textContent=u.label,g.addEventListener("click",()=>{u.action(i),this.hideMenu()}),this.menuElement.appendChild(g)});const o=this.menuElement.offsetWidth,r=this.menuElement.offsetHeight,{innerWidth:c,innerHeight:l}=window;let h=e,d=t;e+o>c&&(h=c-o-5),t+r>l&&(d=l-r-5),this.menuElement.style.top=`${d}px`,this.menuElement.style.left=`${h}px`,document.addEventListener("click",this.boundHideMenu),document.addEventListener("contextmenu",this.boundHideMenu)}hideMenu(e){e&&this.menuElement.contains(e.target)||this.menuElement.style.display==="block"&&(this.menuElement.style.display="none",document.removeEventListener("click",this.boundHideMenu),document.removeEventListener("contextmenu",this.boundHideMenu))}}class S{constructor({title:e="Notice"}={}){this.overlay=document.createElement("div"),this.overlay.className="modal-overlay hidden",this.container=document.createElement("div"),this.container.className="modal-container",this.header=document.createElement("div"),this.header.className="modal-header",this.header.textContent=e,this.content=document.createElement("div"),this.content.className="modal-content",this.content.innerHTML="Loading...",this.footer=document.createElement("div"),this.footer.className="modal-footer",this.footer.style.display="none",this.container.appendChild(this.header),this.container.appendChild(this.content),this.container.appendChild(this.footer),this.overlay.appendChild(this.container),document.body.appendChild(this.overlay)}show(){this.overlay.classList.remove("hidden")}hide(){this.overlay.classList.add("hidden")}destroy(){this.overlay.parentNode&&this.overlay.remove()}updateContent(e){this.content.innerHTML=e}addFooterButton(e,t){this.footer.style.display="flex";const n=document.createElement("button");return n.textContent=e,n.addEventListener("click",t),this.footer.appendChild(n),n}clearFooter(){this.footer.innerHTML="",this.footer.style.display="none"}static prompt({title:e,label:t,defaultValue:n=""}){return new Promise(s=>{const i=new S({title:e}),o=`modal-input-${Date.now()}`,r=`
      ...
      `;i.updateContent(r);const c=i.content.querySelector(`#${o}`),l=()=>{s(c.value),i.destroy()},h=()=>{s(null),i.destroy()};c.addEventListener("keydown",d=>{d.key==="Enter"?(d.preventDefault(),l()):d.key==="Escape"&&h()}),i.addFooterButton("OK",l),i.addFooterButton("Cancel",h),i.show(),c.focus(),c.select()})}static confirm({title:e,message:t,okText:n="OK",cancelText:s="Cancel",destructive:i=!1}){return new Promise(o=>{const r=new S({title:e});r.updateContent(`<p>${t}</p>`);const c=()=>{o(!0),r.destroy()},l=()=>{o(!1),r.destroy()},h=r.addFooterButton(n,c);i&&h.classList.add("destructive"),r.addFooterButton(s,l),r.show()})}static choice({title:e,message:t,choices:n}){return new Promise(s=>{const i=new S({title:e});i.updateContent(t),n.forEach(r=>{const c=i.addFooterButton(r.text,()=>{s(r.id),i.destroy()});r.class&&c.classList.add(r.class)});const o=r=>{r.key==="Escape"&&(s(null),i.destroy(),document.removeEventListener("keydown",o))};document.addEventListener("keydown",o),i.show()})}static selection({title:e,peerData:t,okText:n="Request"}){return new Promise(s=>{if(t.size===0){const l=new S({title:"No Peers Found"});l.updateContent("<p>There are no other peers currently connected to this sync session.</p>"),l.addFooterButton("OK",()=>{l.destroy(),s(null)}),l.show();return}const i=new S({title:e});let o='<div class="peer-selection-container">';t.forEach((l,h)=>{o+=`
        ...
        `},c=Array.from(t.values());let l='<div class="modal-send-container">';l+=r("Gardens to Send",n),l+=r("Peers to Receive",c,!0),l+="</div>",o.updateContent(l),o.content.querySelectorAll(".modal-selection-group").forEach(u=>{u.querySelector(".select-all-btn").onclick=()=>u.querySelectorAll(".modal-select-checkbox").forEach(g=>g.checked=!0),u.querySelector(".select-none-btn").onclick=()=>u.querySelectorAll(".modal-select-checkbox").forEach(g=>g.checked=!1)});const h=()=>{const u=Array.from(o.content.querySelectorAll("#group-GardenstoSend .modal-select-checkbox:checked")).map(f=>f.value),g=Array.from(o.content.querySelectorAll("#group-PeerstoReceive .modal-select-checkbox:checked")).map(f=>f.value);u.length>0&&g.length>0?i({gardens:u,peers:g}):i(null),o.destroy()},d=()=>{i(null),o.destroy()};o.addFooterButton(s,h),o.addFooterButton("Cancel",d),o.show()})}}function Jt(a){const e={};a.sort((t,n)=>t.path.localeCompare(n.path));for(const{path:t,isDirectory:n}of a){const s=t.substring(1).split("/");let i=e;for(let o=0;o<s.length;o++){const r=s[o];o===s.length-1?i[r]||(i[r]=n?{type:"folder",path:t,children:{}}:{type:"file",path:t}):(i[r]||(i[r]={type:"folder",path:"/"+s.slice(0,o+1).join("/"),children:{}}),i[r].children||(i[r].children={}),i=i[r].children)}}return e}function We(a,e,t,n,s){const i=Object.keys(a).sort((r,c)=>{const l=a[r],h=a[c];return l.type==="folder"&&h.type!=="folder"?-1:l.type!=="folder"&&h.type==="folder"?1:r.localeCompare(c,void 0,{numeric:!0})});let o="";for(const r of i){const c=a[r],l=`padding-left: ${s*20}px;`;if(c.type==="folder"){const h=n.has(c.path);o+=`
...
- key: "Alt-z"
  run: "settings/keymaps/toggle-maximize-pane.js"`,Xt=`// This is the primary action script for the "Mod-Enter" keyboard shortcut.
...
});`,Zt=`// This script is the action for the "Mod-Shift-Enter" keyboard shortcut.
// It is context-aware:
...
window.thoughtform.ui.toggleSidebar?.();`,en=`// This script toggles the visibility of the Eruda devtools panel.
window.thoughtform.ui.toggleDevtools?.();`,tn=`// This script opens the command palette in "searchFiles" mode.
window.thoughtform.commandPalette.open('searchFiles');`,nn=`// This script opens the command palette in "executeCommand" mode for running commands.
window.thoughtform.commandPalette.open('executeCommand');`,sn=`// This script opens the command palette in "searchContent" mode.
window.thoughtform.commandPalette.open('searchContent');`,on=`// This script navigates back in the browser's history.
window.history.back();`,rn=`// This script navigates forward in the browser's history.
window.history.forward();`,an=`// This script duplicates the currently active file in the editor.
...
}`,cn=`// This script duplicates the currently active garden.
...
}`,ln=`// This script renames the currently active file in the editor.
// It will trigger a modal to ask for the new file name.
...
}`,dn=`// This script creates a new file by calling the editor's core functionality.
...
}`,hn=`// This script creates a new garden by calling the sidebar's core functionality.
...
}`,un=`// This script runs automatically whenever a new file is created.
//
...
console.log('Created file:', event.path);`,gn=`// This script runs automatically when the application finishes loading.
//
// The 'event' variable is available in this script's scope.
// For 'app:load', it is null.

console.log('HOOK::', window.location.origin + '/Settings#settings/hooks/load.js');`,fn=`// This script runs automatically whenever a file or folder is deleted.
//
// The 'event' variable is available in this script's scope
// and contains data about the event that triggered the hook.
...
console.log('Deleted item:', event.path, 'isDirectory:', event.isDirectory);`,pn=`// This script splits the currently active pane vertically.
...
}`,mn=`// This script splits the currently active pane horizontally.

const workspace = window.thoughtform.workspace;
if (workspace && workspace.activePaneId) {
  workspace.splitPane(workspace.activePaneId, 'horizontal');
}`,wn=`// This script changes focus to the next available pane.
window.thoughtform.workspace.selectNextPane();`,yn=`// This script changes focus to the previous available pane.
window.thoughtform.workspace.selectPrevPane();`,vn=`// This script swaps the active pane with its previous sibling.
window.thoughtform.workspace.movePaneUp();`,bn=`// This script swaps the active pane with its next sibling.
window.thoughtform.workspace.movePaneDown();`,Cn=`// This script closes the currently active pane.
window.thoughtform.workspace.closeActivePane();`,Sn=`// This script toggles the maximization state of the currently active pane.
window.thoughtform.workspace.toggleMaximizePane();`,kn=`// This is a test script for the query parameter autoloader.
...
}`,En=`// This script runs automatically whenever a new preview window is created.
//
// The 'event' variable is available in this script's scope
// and contains data about the event that triggered the hook.
...
console.log('Created window:', event.windowId, 'with URL:', event.url);`,xn=`// This script runs automatically whenever a preview window is closed.
//
// The 'event' variable is available in this script's scope
// and contains data about the event that triggered the hook.
...
console.log('Closed window:', event.windowId);`,Tn=`// This script runs automatically whenever a preview window is resized.
...
console.log(\`Resized window \${event.windowId} to \${event.width}x\${event.height}\`);`,In=`// This script is the action for the "Alt-Enter" keyboard shortcut.
...
# YOUR ASSESSMENT (CONTINUE or FINISH)`,Ve=`You are a Deep Research Analyst. Your role is to synthesize a final, comprehensive, and multi-faceted answer based on the extensive research you have conducted.
...
return 'Error: Invalid scope. Use "current" or "all".';`,Rn=`/*
Description:
...
});`,_n=`// This script runs automatically when you navigate to a URL with \`?model=...\`
...
}`,Fn=`// This script runs automatically when you navigate to a URL with \`?api=...\`
...
}`,Dn=`// This script runs automatically when you navigate to a URL with \`?apiKey=...\`
...
}`,On=`// This script runs automatically when you navigate to a URL with \`?provider=...\`
...
`)[0],i=n.oid.substring(0,7),o=n.commit.author.name,r=new Date(n.commit.author.timestamp*1e3).toLocaleString(),c=n.commit.parent[0]||"";return`
    ...
    `,this.tabsContainer.querySelectorAll(".sidebar-tab").forEach(e=>{e.addEventListener("click",t=>{const n=t.target.dataset.tab,s=this.activeTab;if(this.activeTab=n,sessionStorage.setItem("sidebarActiveTab",this.activeTab),s==="Git"&&n!=="Git"){const i=this.editor.getFilePath(window.location.hash);this.editor.loadFile(i)}this.refresh()})})}async refresh(){this.tabsContainer.querySelectorAll(".sidebar-tab").forEach(n=>{n.classList.toggle("active",n.dataset.tab===this.activeTab)}),this.contentContainer.className="sidebar-content",this.contentContainer.classList.add(`${this.activeTab.toLowerCase()}-view`);const e=await this.gitClient.getStatuses();this.activeTab==="Files"?await this.renderFiles(e):this.activeTab==="Gardens"?await this.renderGardens():this.activeTab==="Git"&&await this.renderGitView();const t=e.some(([,n,s])=>n!==s);this.tabsContainer.querySelector('[data-tab="Git"]').classList.toggle("dirty",t)}async listAllPaths(e,t){const n=e.pfs;let s=[];try{const i=await n.readdir(t);for(const o of i){if(o===".git")continue;const r=`${t==="/"?"":t}/${o}`;try{const c=await n.stat(r);if(s.push({path:r,isDirectory:c.isDirectory()}),c.isDirectory()){const l=await this.listAllPaths(e,r);s=s.concat(l)}}catch{console.warn(`Could not stat ${r}, skipping.`)}}}catch{console.log(`Directory not found: ${t}. No items to list.`)}return s}}function zn(a){const e=document.createElement("div");e.id="drag-overlay",e.innerHTML="<p>Drop files or folders to add them to the garden</p>",document.body.appendChild(e);const t=document.querySelector("main");if(!t){console.error("[DragDrop] Main container not found. Drag and drop to editor panes will not be handled correctly.");return}const n=o=>{e.innerHTML=`<p>${o}</p>`,e.classList.add("visible")},s=()=>{e.classList.remove("visible")},i=async(o,r,c)=>{let l=o;if(o.some(m=>m.isDirectory&&m.name===".git")){const m=await S.choice({title:".git Directory Detected",message:"<p>The content you dropped contains a .git repository. This could unintentionally overwrite your garden's history.</p><p>How would you like to proceed?</p>",choices:[{id:"import_safe",text:"Import Files (Ignore .git folder)"},{id:"cancel",text:"Cancel Import",class:"destructive"}]});if(!m||m==="cancel"){r("Import cancelled by user.","Import cancelled by user.");return}l=o.filter(b=>!(b.isDirectory&&b.name===".git")),r("Ignoring .git directory and proceeding with import.","Ignoring .git directory.")}const d=[],u=[],g=["png","jpg","jpeg","gif","svg","webp","avif","mp4","webm","mov","ogg","mp3","wav","flac","pdf","doc","docx","xls","xlsx","ppt","pptx"],f=async(m,b)=>{if(m.isFile){const C=await new Promise(T=>m.file(T)),x=`${b}/${C.name}`;C.name.toLowerCase().endsWith(".zip")?u.push(C):d.push({file:C,path:x})}else if(m.isDirectory){const C=m.createReader(),x=await new Promise(T=>C.readEntries(T));for(const T of x)await f(T,`${b}/${m.name}`)}};r("Scanning dropped items...","Scanning dropped items...");for(const m of l)await f(m,"");const p=`Found ${d.length} file(s) and ${u.length} zip archive(s) to process.`;r(p,p);const y=d.map(async({file:m,path:b})=>{let C;const x=m.name.split(".").pop()?.toLowerCase();return g.includes(x)?C=await m.arrayBuffer():C=await m.text(),c.writeFile(b,C)});if((await Promise.allSettled(y)).forEach((m,b)=>{const C=d[b].path;if(m.status==="rejected"){const x=`<span style="color: var(--color-text-destructive);">ERROR:</span> Failed to write "${C}": ${m.reason}`,T=`ERROR: Failed to write "${C}": ${m.reason}`;r(x,T)}else{const x=`<span style="color: var(--color-text-success);">OK:</span> Imported "${C}"`,T=`OK: Imported "${C}"`;r(x,T)}}),u.length>0){const m="Note: Zip archives must be imported via the DevTools > Data panel.";r(m,m)}};t.addEventListener("dragover",o=>{o.preventDefault()}),t.addEventListener("drop",o=>{o.preventDefault()}),window.addEventListener("dragenter",o=>{o.preventDefault(),o.dataTransfer.types.includes("Files")&&n("Drop files or folders to add them to the garden")}),window.addEventListener("dragover",o=>{o.preventDefault()}),window.addEventListener("dragleave",o=>{o.clientX===0&&o.clientY===0&&s()}),window.addEventListener("drop",async o=>{o.preventDefault(),s();const r=o.dataTransfer.items;if(!r||r.length===0)return;const c=Array.from(r).map(l=>l.webkitGetAsEntry()).filter(Boolean);if(c.length>0){const l=await window.thoughtform.workspace.getActiveGitClient();if(!l){console.error("[DragDrop] Could not determine active garden. Aborting import.");const f=new S({title:"Import Error"});f.updateContent("<p>Could not determine the active garden. Please click inside an editor pane and try again.</p>"),f.addFooterButton("Close",()=>f.destroy()),f.show();return}const h=new S({title:`Importing to "${l.gardenName}"...`}),d=document.createElement("div");d.style.fontFamily="monospace",d.style.maxHeight="300px",d.style.overflowY="auto",d.style.fontSize="12px",h.updateContent(""),h.content.appendChild(d),h.show();let u="";const g=(f,p)=>{console.log(`[Import Log] ${p}`),u+=`<div>${f}</div>`,d.innerHTML=u,d.scrollTop=d.scrollHeight};try{await i(c,g,l),g("<strong>Import process complete.</strong>","Import process complete.")}catch(f){const p=`<strong style="color: var(--color-text-destructive);">A critical error occurred: ${f.message}</strong>`,y=`A critical error occurred: ${f.message}`;g(p,y),console.error("[DragDrop] A critical error occurred during import:",f)}finally{h.addFooterButton("Close",()=>h.destroy()),await a.refresh()}}})}const Te=ft.define(pt),Hn=mt({base:Ct,codeLanguages:[ee.of({name:"javascript",load:()=>Promise.resolve(De())}),ee.of({name:"html",load:()=>Promise.resolve(Oe())}),ee.of({name:"css",load:()=>Promise.resolve(Ue())}),ee.of({name:"mermaid",load:()=>Promise.resolve(wt())})]});function be(a){const e=a.split("/").pop(),t=e.includes(".")?e.split(".").pop().toLowerCase():"";switch(e){case".gitignore":case".npmrc":case".editorconfig":case"Dockerfile":return Te}switch(t){case"js":return De();case"css":return Ue();case"html":return Oe();case"json":return bt();case"xml":return vt();case"yaml":case"yml":return yt();case"sh":case"bash":case"zsh":return Te;default:return Hn}}const F=Ge.define({create:()=>({gitClient:null,sidebar:null,editor:null}),update:(a,e)=>a});async function he(a,e){if(!e.sidebar||!e.gitClient)return null;const t=await e.sidebar.listAllPaths(e.gitClient,"/"),n=a.toLowerCase();for(const{path:s,isDirectory:i}of t){if(i)continue;const o=s;if((o.startsWith("/")?o.substring(1):o).toLowerCase()===n)return o}return null}async function Wn(a,e){const t=new E(a);try{return await t.readFile(e)}catch(n){if(n.message.includes("does not exist")&&a!=="Settings"){const s=new E("Settings");try{return await s.readFile(e)}catch(i){if(i.message.includes("does not exist"))return null;throw i}}if(n.message.includes("does not exist"))return null;throw n}}async function se(a,e,t,n=null,s=null){try{let[i,o]=a.split("#");o.startsWith("/")||(o=`/${o}`);const r=await Wn(i,o);if(r===null)return;const c=`(function(editor, git, event, params) {
      try {
        ${r}
      } catch (e) {
        console.error(
...
${e.message}</pre></div>`;return te.set(a,t),t}}class Ms extends Be{constructor(e){super(),this.code=e}eq(e){return this.code===e.code}toDOM(){const e=document.createElement("div");return e.className="cm-mermaid-container",e.innerHTML="<p>Loading diagram...</p>",setTimeout(()=>{e.isConnected&&Ns(this.code).then(t=>{e.innerHTML=t})},0),e}}function Le(a){const e=new R;return K(a.state).iterate({enter:n=>{if(n.name==="FencedCode"){const s=n.node.getChild("CodeInfo");if(s&&a.state.doc.sliceString(s.from,s.to).trim()==="mermaid"){const o=n.node.getChild("CodeText");if(o){const r=a.state.doc.sliceString(o.from,o.to);e.add(n.to,n.to,$.widget({widget:new Ms(r),side:1}))}}}}}),e.finish()}const Rs=M.fromClass(class{constructor(a){this.decorations=Le(a)}update(a){(a.docChanged||K(a.startState)!==K(a.state))&&(this.decorations=Le(a.view))}},{decorations:a=>a.decorations}),Qe=[es,ls,gs,ps,vs,Cs,ks,Is,$s,As,Rs],_s=[...Qe,xs],Fs=$.mark({class:"cm-diff-inserted"});function Ae(a,e){const t=[],n=e.doc.toString(),s=re(a,n);let i=0;for(const[o,r]of s)o===re.INSERT&&t.push(Fs.range(i,i+r.length)),o!==re.DELETE&&(i+=r.length);return $.set(t)}const pe=new z;function Ds(a){return Ge.define({create(e){return Ae(a,e)},update(e,t){return t.docChanged?Ae(a,t.state):e.map(t.changes)},provide:e=>D.decorations.from(e)})}const Os=new z,et=M.fromClass(class{constructor(a){this.view=a,this.statusBar=document.createElement("div"),this.statusBar.className="status-bar",this.filePathElement=document.createElement("span"),this.filePathElement.className="status-bar-filepath",this.tokenCountElement=document.createElement("span"),this.tokenCountElement.className="status-bar-token-count",this.statusBar.appendChild(this.filePathElement),this.statusBar.appendChild(this.tokenCountElement),a.dom.parentElement?a.dom.parentElement.appendChild(this.statusBar):console.error("Could not find a parent element for the editor view to attach the status bar."),this.debouncedUpdate=de(this.updateAll.bind(this),100),this.updateAll()}update(a){(a.docChanged||a.selectionSet||a.viewportChanged)&&this.debouncedUpdate()}getDisplayPath(){const a=this.view.state.field(F);if(!a||!a.editor)return"...";const e=a.editor.gitClient.gardenName,t=a.editor.filePath||"/untitled";return`[${e}] ${t}`}updateAll(){if(!this.view.dom.isConnected)return;const a=this.getDisplayPath();this.filePathElement.textContent!==a&&(this.filePathElement.textContent=a);try{const e=this.view.state.doc.toString(),n=`Tokens: ${X(e).toLocaleString()}`;this.tokenCountElement.textContent!==n&&(this.tokenCountElement.textContent=n)}catch{this.tokenCountElement.textContent="Tokens: Error"}}destroy(){this.debouncedUpdate.cancel(),this.statusBar&&this.statusBar.remove()}});function Us(){return et}function Gs({appContext:a,dynamicKeymapExtension:e,vimCompartment:t,defaultKeymapCompartment:n,languageCompartment:s,appContextCompartment:i,updateListener:o,filePath:r,getLanguageExtension:c}){return[i.of(a),e,t.of([]),n.of(j.of(ze)),j.of([Ot]),kt(),Et(),xt(),Tt(),It(),Pt(),$t(),we.allowMultipleSelections.of(!0),Lt(),me(qe,{fallback:!0}),At(),Nt(),Mt(),Rt(),_t(),Ft(),j.of([...Ut,...Gt,...Bt,...qt,...zt,...Ht]),D.lineWrapping,Dt,Je,s.of(c(r)),o,..._s,pe.of([]),Os.of(Us()),D.domEventHandlers({drop(l,h){return l.dataTransfer&&l.dataTransfer.files.length>0?(l.preventDefault(),!0):!1}})]}async function tt(a){const e=new Date,t=String(e.getFullYear()).slice(-2),n=String(e.getMonth()+1).padStart(2,"0"),s=String(e.getDate()).padStart(2,"0"),i=String(e.getHours()).padStart(2,"0"),o=String(e.getMinutes()).padStart(2,"0"),r=`${t}${n}${s}-${i}${o}`,c="/scratchpad";await a.ensureDir(c);let l=`${c}/${r}`,h=0;for(;;)try{await a.pfs.stat(l),h++,l=`${c}/${r}-${h}`}catch(d){if(d.code==="ENOENT")break;throw d}return l}class Bs{constructor(e){this.editor=e}getFilePath(e){let t=e.startsWith("#")?e.substring(1):e;return t=decodeURIComponent(t),t||(t="home"),t}async loadFileContent(e){try{return await this.editor.gitClient.readFile(e)}catch(t){return t.message&&t.message.includes("does not exist")||console.warn(`An unexpected error occurred while reading ${e}:`,t),`// "${e.substring(1)}" does not exist. Start typing to create it.`}}async loadFile(e){const t=["png","jpg","jpeg","gif","svg","webp","avif"],n=["mp4","webm","mov","ogg"],s=["mp3","wav","flac"],i=[...t,...n,...s],o=e.split(".").pop()?.toLowerCase();if(i.includes(o)){this.editor.hideDiff(),this.editor.targetElement.classList.remove("is-editor"),this.editor.targetElement.classList.add("is-media-preview"),this.editor.mediaViewerElement.innerHTML="<p>Loading media...</p>";const h=await this.editor.gitClient.readFileAsBuffer(e);if(h){const u={png:"image/png",jpg:"image/jpeg",jpeg:"image/jpeg",gif:"image/gif",svg:"image/svg+xml",webp:"image/webp",avif:"image/avif",mp4:"video/mp4",webm:"video/webm",mov:"video/quicktime",ogg:"video/ogg",mp3:"audio/mpeg",wav:"audio/wav",flac:"audio/flac"}[o]||"application/octet-stream",g=new Blob([h],{type:u});this.editor.currentMediaObjectUrl&&URL.revokeObjectURL(this.editor.currentMediaObjectUrl),this.editor.currentMediaObjectUrl=URL.createObjectURL(g);let f="";t.includes(o)?f=`<img src="${this.editor.currentMediaObjectUrl}" alt="${e}" />`:n.includes(o)?f=`<video src="${this.editor.currentMediaObjectUrl}" controls></video>`:s.includes(o)&&(f=`<audio src="${this.editor.currentMediaObjectUrl}" controls></audio>`),this.editor.mediaViewerElement.innerHTML=f;const p=this.editor.mediaViewerElement.querySelector("video, audio");p&&p.load()}else this.editor.mediaViewerElement.innerHTML=`<p class="error">Could not load media: ${e}</p>`;this.editor.filePath=e,this.editor.sidebar&&await this.editor.sidebar.refresh(),await this.editor._applyUserSettings();return}this.editor.targetElement.classList.remove("is-media-preview"),this.editor.targetElement.classList.add("is-editor"),this.editor.currentMediaObjectUrl&&(URL.revokeObjectURL(this.editor.currentMediaObjectUrl),this.editor.currentMediaObjectUrl=null),this.editor.hideDiff();const r=await this.loadFileContent(e);this.editor.filePath=e;const c=be(e);this.editor.editorView.dispatch({effects:this.editor.languageCompartment.reconfigure(c)});const l=this.editor.editorView.state.doc;this.editor.editorView.dispatch({changes:{from:0,to:l.length,insert:r},annotations:this.editor.programmaticChange.of(!0)}),this.editor.sidebar&&await this.editor.sidebar.refresh(),await this.editor._applyUserSettings()}async forceReloadFile(e){if(this.editor.filePath!==e||!this.editor.editorView){await this.loadFile(e);return}const t=this.editor.editorView.state.selection,n=this.editor.editorView.scrollDOM.scrollTop,s=await this.loadFileContent(e),i=this.editor.editorView.state.doc;if(s===i.toString())return;const o=s.length,r={changes:{from:0,to:i.length,insert:s},annotations:this.editor.programmaticChange.of(!0),selection:{anchor:Math.min(t.main.anchor,o),head:Math.min(t.main.head,o)}};this.editor.editorView.dispatch(r),requestAnimationFrame(()=>{this.editor.editorView&&this.editor.editorView.scrollDOM&&(this.editor.editorView.scrollDOM.scrollTop=n)})}async newFile(){try{const e=await S.prompt({title:"New File",label:"Enter file name (or leave blank for a scratchpad):"});if(e===null){this.editor.editorView?.focus();return}let t;if(!e.trim())t=await tt(this.editor.gitClient);else{const n=e.trim();t=`/${n}`;try{const i=(await this.editor.gitClient.pfs.stat(t)).isDirectory()?"folder":"file";await this.editor.sidebar.showAlert({title:"Creation Failed",message:`A ${i} named "${n}" already exists.`});return}catch(s){if(s.code!=="ENOENT"){console.error("Error checking for file:",s),await this.editor.sidebar.showAlert({title:"Error",message:"An unexpected error occurred."});return}}}window.thoughtform.workspace.openFile(this.editor.gitClient.gardenName,t)}finally{}}async duplicateFile(e){if(e)try{if((await this.editor.gitClient.pfs.stat(e)).isDirectory()){await this.editor.sidebar.showAlert({title:"Action Not Supported",message:"Duplicating folders is not yet supported."});return}const n=e.substring(0,e.lastIndexOf("/")),s=e.substring(e.lastIndexOf("/")+1),i=`${s.split(".").slice(0,-1).join(".")||s} (copy)${s.includes(".")?"."+s.split(".").pop():""}`,o=await S.prompt({title:"Duplicate File",label:"Enter name for duplicated file:",defaultValue:i});if(o===null){this.editor.editorView?.focus();return}if(!o.trim())return;const r=`${n}/${o.trim()}`;try{const c=await this.editor.gitClient.readFile(e);await this.editor.gitClient.writeFile(r,c),window.thoughtform.workspace.openFile(this.editor.gitClient.gardenName,r)}catch(c){console.error("Error duplicating file:",c),await this.editor.sidebar.showAlert({title:"Error",message:`Failed to duplicate file: ${c.message}`})}}finally{}}}class qs{constructor(e){this.editor=e}async showDiff(e){if(e===null){this.hideDiff();return}const t=Ds(e);this.editor.editorView.dispatch({effects:pe.reconfigure(t)})}hideDiff(){this.editor.editorView.dispatch({effects:pe.reconfigure([])})}async previewHistoricalFile(e,t,n){const[s,i]=await Promise.all([this.editor.gitClient.readBlobFromCommit(t,e),this.editor.gitClient.readBlobFromCommit(n,e)]);if(s===null||i===null){await this.editor.sidebar.showAlert({title:"Error",message:"Could not load historical diff for this file."});return}this.editor.editorView.dispatch({changes:{from:0,to:this.editor.editorView.state.doc.length,insert:s},annotations:this.editor.programmaticChange.of(!0)}),this.showDiff(i)}}class zs{constructor(e){this.editor=e}getCurrentState(){return this.editor.editorView?{selection:{main:{anchor:this.editor.editorView.state.selection.main.anchor,head:this.editor.editorView.state.selection.main.head}},scrollTop:this.editor.editorView.scrollDOM.scrollTop}:null}restoreState(e){if(!this.editor.editorView||!e)return;const t=this.editor.editorView.state.update({selection:{anchor:e.selection.main.anchor,head:e.selection.main.head}});this.editor.editorView.dispatch(t),requestAnimationFrame(()=>{this.editor.editorView.scrollDOM&&(this.editor.editorView.scrollDOM.scrollTop=e.scrollTop)})}}class Ce{static editors=[];constructor({target:e,editorConfig:t={},gitClient:n,commandPalette:s,initialFile:i,paneId:o}){if(!n)throw new Error("Editor requires a gitClient instance.");if(!s)throw new Error("Editor requires a commandPalette instance.");this.targetElement=typeof e=="string"?document.querySelector(e):e,this.editorConfig=t,this.gitClient=n,this.commandPalette=s,this.paneId=o,this.editorView=null,this.sidebar=null,this.filePath=i||"/home",this.isReady=!1,this.keymapService=null,this.aiOverrides={},this.languageCompartment=new z,this.vimCompartment=new z,this.defaultKeymapCompartment=new z,this.appContextCompartment=new z,this.mediaViewerElement=null,this.currentMediaObjectUrl=null,this.programmaticChange=Wt.define(),this._files=new Bs(this),this._git=new qs(this),this._state=new zs(this),this.debouncedHandleUpdate=de(this.handleUpdate.bind(this),500),this.debouncedStateSave=de(()=>{window.thoughtform.workspace?._saveStateToSession()},500),this.init()}async init(){if(!this.targetElement){console.error("Target container not found or provided.");return}if(document.querySelector("#sidebar").hasChildNodes())this.sidebar=window.thoughtform.sidebar;else{await this.gitClient.initRepo(),this.sidebar=new qn({target:"#sidebar",gitClient:this.gitClient,editor:this}),await this.sidebar.init(),window.thoughtform._dragDropInitialized||(zn(this.sidebar),window.thoughtform._dragDropInitialized=!0);const r=document.getElementById("loading-indicator");r&&r.remove(),document.querySelector(".main-content").style.display="flex"}window.thoughtform.sidebar||(window.thoughtform.sidebar=this.sidebar);let e=await this._files.loadFileContent(this.filePath);this.mediaViewerElement=document.createElement("div"),this.mediaViewerElement.className="media-viewer-container",this.targetElement.appendChild(this.mediaViewerElement);const t=D.updateListener.of(r=>{r.docChanged&&!r.transactions.some(c=>c.annotation(this.programmaticChange))&&this.debouncedHandleUpdate(r.state.doc.toString()),(r.selectionSet||r.viewportChanged)&&this.debouncedStateSave()}),n=we.create({doc:e}),s=new D({state:n});this.keymapService=new Jn(s);const i=this.keymapService.getCompartment(),o=Gs({appContext:F.init(()=>({gitClient:this.gitClient,sidebar:this.sidebar,editor:this})),dynamicKeymapExtension:i,vimCompartment:this.vimCompartment,defaultKeymapCompartment:this.defaultKeymapCompartment,languageCompartment:this.languageCompartment,appContextCompartment:this.appContextCompartment,updateListener:t,filePath:this.filePath,getLanguageExtension:be});this.editorView=new D({doc:e,extensions:o,parent:this.targetElement}),this.keymapService.editorView=this.editorView,s.destroy(),Ce.editors.push(this),this.isReady=!0,await this.loadFile(this.filePath)}async _applyUserSettings(){const{value:e}=await window.thoughtform.config.get("interface.yml","editingMode",this);e==="vim"?(jt.map("jj","<Esc>","insert"),this.editorView.dispatch({effects:[this.vimCompartment.reconfigure(Kt()),this.defaultKeymapCompartment.reconfigure([])]})):this.editorView.dispatch({effects:[this.vimCompartment.reconfigure([]),this.defaultKeymapCompartment.reconfigure(j.of(ze))]}),this.keymapService&&await this.keymapService.updateKeymaps()}async navigateTo(e){if(!e)return;let t=e.split("|")[0].trim(),n=null;if(t.includes("#")&&([n,t]=t.split("#")),n&&n!==this.gitClient.gardenName)window.thoughtform.workspace.openFile(n,t.startsWith("/")?t:`/${t}`);else{const s=this.gitClient.gardenName;let o=await he(t,{gitClient:this.gitClient,sidebar:this.sidebar})||(t.startsWith("/")?t:`/${t}`);window.thoughtform.workspace.openFile(s,o)}}async handleUpdate(e){this.isReady&&(await this.gitClient.writeFile(this.filePath,e),window.thoughtform.events.publish("file:update",{gardenName:this.gitClient.gardenName,path:this.filePath,content:e}),window.thoughtform.workspace.notifyFileUpdate(this.gitClient.gardenName,this.filePath,this.paneId),this.sidebar&&await this.sidebar.refresh())}refreshStatusBar(){if(this.editorView){const e=this.editorView.plugin(et);e&&e.updateAll()}}getFilePath(e){return this._files.getFilePath(e)}loadFileContent(e){return this._files.loadFileContent(e)}loadFile(e){return this._files.loadFile(e)}forceReloadFile(e){return this._files.forceReloadFile(e)}newFile(){return this._files.newFile()}duplicateFile(e){return this._files.duplicateFile(e)}showDiff(e){return this._git.showDiff(e)}hideDiff(){return this._git.hideDiff()}previewHistoricalFile(e,t,n){return this._git.previewHistoricalFile(e,t,n)}getCurrentState(){return this._state.getCurrentState()}restoreState(e){return this._state.restoreState(e)}}function Hs(){Ws(),js()}function Ws(){const a=document.querySelector(".app-container"),e=document.getElementById("resizer"),t=document.getElementById("resize-overlay");if(!a||!e||!t)return;const n=document.createElement("button");n.id="sidebar-toggle-icon",n.title="Toggle Sidebar (Ctrl + [)",e.appendChild(n);let s=0,i=!1;const o=()=>{if(a.classList.contains("sidebar-collapsed")){const p=localStorage.getItem("sidebarWidth")||"250px";a.classList.remove("sidebar-collapsed"),document.documentElement.style.setProperty("--sidebar-width",p),localStorage.setItem("sidebarCollapsed","false"),n.textContent="‹"}else{const p=document.documentElement.style.getPropertyValue("--sidebar-width");p!=="0px"&&localStorage.setItem("sidebarWidth",p),a.classList.add("sidebar-collapsed"),document.documentElement.style.setProperty("--sidebar-width","0px"),localStorage.setItem("sidebarCollapsed","true"),n.textContent="›"}};window.thoughtform&&window.thoughtform.ui&&(window.thoughtform.ui.toggleSidebar=o);const r=f=>{f.type==="touchmove"&&f.preventDefault();const p=f.clientX||f.touches&&f.touches[0].clientX;if(Math.abs(p-s)>5&&(i=!0),i){const y=Math.max(24,Math.min(p,window.innerWidth-100));document.documentElement.style.setProperty("--sidebar-width",`${y}px`),a.classList.remove("sidebar-collapsed"),n.textContent="‹"}},c=()=>{if(t.style.display="none",document.body.style.cursor="default",document.body.style.userSelect="auto",document.removeEventListener("mousemove",r),document.removeEventListener("touchmove",r),document.removeEventListener("mouseup",c),document.removeEventListener("touchend",c),i){const f=document.documentElement.style.getPropertyValue("--sidebar-width");localStorage.setItem("sidebarWidth",f),localStorage.setItem("sidebarCollapsed","false")}else o()},l=f=>{s=f.clientX||f.touches&&f.touches[0].clientX,i=!1,f.preventDefault(),t.style.display="block",document.body.style.cursor="col-resize",document.body.style.userSelect="none",document.addEventListener("mousemove",r,{passive:!1}),document.addEventListener("touchmove",r,{passive:!1}),document.addEventListener("mouseup",c),document.addEventListener("touchend",c)};e.addEventListener("mousedown",l),e.addEventListener("touchstart",l,{passive:!1});const d=(window.location.hash||"").includes("?windowed=true"),u=localStorage.getItem("sidebarWidth");d||localStorage.getItem("sidebarCollapsed")==="true"?(a.classList.add("sidebar-collapsed"),document.documentElement.style.setProperty("--sidebar-width","0px"),n.textContent="›"):(document.documentElement.style.setProperty("--sidebar-width",u||"250px"),n.textContent="‹")}function js(){const a=document.getElementById("eruda-container"),e=document.getElementById("eruda-resizer");let t;if(!a||!e)return;const n=document.createElement("button");n.id="eruda-toggle",n.title="Toggle DevTools (Ctrl + `)",e.appendChild(n);let s=0,i=!1;const o=(d=null,u=null)=>{if(t=document.querySelector(".eruda-dev-tools"),!t)return;const g=t.style.height==="0px"||t.offsetHeight<10;if(d===null?g:d){const p=localStorage.getItem("erudaHeight")||"250px";t.style.height=p,n.textContent="▼",localStorage.setItem("erudaCollapsed","false"),u&&setTimeout(()=>window.thoughtform.eruda?.show(u),50)}else{if(g)return;localStorage.setItem("erudaHeight",t.style.height),t.style.height="0px",n.textContent="▲",localStorage.setItem("erudaCollapsed","true")}};window.thoughtform&&window.thoughtform.ui&&(window.thoughtform.ui.toggleDevtools=o);const r=d=>{d.type==="touchmove"&&d.preventDefault();const u=d.clientY||d.touches&&d.touches[0].clientY;if(Math.abs(u-s)>5&&(i=!0),!i)return;const g=window.innerHeight-u,f=42,p=window.innerHeight-100;t.style.height=`${Math.max(f,Math.min(g,p))}px`,n.textContent="▼"},c=()=>{document.body.style.cursor="default",document.body.style.userSelect="auto",document.removeEventListener("mousemove",r),document.removeEventListener("touchmove",r),document.removeEventListener("mouseup",c),document.removeEventListener("touchend",c),i?(localStorage.setItem("erudaHeight",t.style.height),localStorage.setItem("erudaCollapsed","false")):o(null,null)},l=d=>{s=d.clientY||d.touches&&d.touches[0].clientY,i=!1,d.preventDefault(),t=document.querySelector(".eruda-dev-tools"),t&&(document.body.style.cursor="row-resize",document.body.style.userSelect="none",document.addEventListener("mousemove",r,{passive:!1}),document.addEventListener("touchmove",r,{passive:!1}),document.addEventListener("mouseup",c),document.addEventListener("touchend",c))};e.addEventListener("mousedown",l),e.addEventListener("touchstart",l,{passive:!1});const h=new MutationObserver(()=>{t=document.querySelector(".eruda-dev-tools"),t&&((window.location.hash||"").includes("?windowed=true")||localStorage.getItem("erudaCollapsed")==="true"?(t.style.height="0px",n.textContent="▲"):(t.style.height=localStorage.getItem("erudaHeight")||"150px",n.textContent="▼"),h.disconnect())});h.observe(a,{childList:!0})}class Ks{constructor(){const e=new URLSearchParams(window.location.search);this.isEnabled=e.has("debug"),console.log(`[DEBUG] Debug mode is ${this.isEnabled?"ENABLED":"DISABLED"}`)}log(...e){this.isEnabled&&console.log("[DEBUG]",...e)}error(...e){this.isEnabled&&console.error("[DEBUG]",...e)}warn(...e){this.isEnabled&&console.warn("[DEBUG]",...e)}}const k=new Ks;class Vs{constructor(e){this.signaling=e}connectToSignalingServer(){return new Promise((e,t)=>{const n=this.signaling.signalingServerUrl;if(this.signaling.ws&&this.signaling.ws.readyState===WebSocket.OPEN){e();return}this.signaling.ws=new WebSocket(n),this.signaling.ws.onopen=()=>{k.log(`Connected to signaling server at ${n}`),e()},this.signaling.ws.onclose=()=>{k.log("Disconnected from signaling server"),this.signaling.sync.disconnect()},this.signaling.ws.onerror=s=>{k.error("WebSocket error:",s),this.signaling.sync.updateConnectionState("error","Signaling server connection error."),t(new Error(`Failed to connect to signaling server at ${n}`))},this.signaling.ws.onmessage=s=>{try{const i=JSON.parse(s.data);this.signaling._signalingMessageHandler&&this.signaling._signalingMessageHandler.handleSignalingMessage(i)}catch(i){k.error("Error parsing signaling message:",i)}}})}sendJoinSessionRequest(e,t){const n=this.signaling.ws;if(n&&n.readyState===WebSocket.OPEN){const s={type:"join_session",sessionId:e};t&&(s.peerNamePrefix=t),n.send(JSON.stringify(s))}else k.error("Cannot send join session request, WebSocket is not open.")}sendSignal(e,t){const n=this.signaling.ws;n&&n.readyState===WebSocket.OPEN&&n.send(JSON.stringify({type:"signal",target:t,data:e}))}}class Js{constructor(e){this.signaling=e}handleSignalingMessage(e){const t=this.signaling.sync;switch(e.type){case"welcome":k.log("Received welcome from signaling server.");break;case"session_joined":this.signaling.peerId=e.peerId,t.updateConnectionState("connected-signal","Connected to tracker, waiting for peers..."),e.peers&&e.peers.length>0&&e.peers.forEach(n=>{this.signaling.connectToPeer(n)});break;case"peer_joined":this.signaling.connectToPeer(e.peerId);break;case"signal":e.from&&e.data&&this.signaling.handleSignal(e.from,e.data);break;case"peer_left":e.peerId&&t.handlePeerLeft(e.peerId);break;case"error":t.updateConnectionState("error",`Signaling error: ${e.message}`);break}}}const Ys=500;class Xs{constructor(e){this.signaling=e,this.sync=e.sync,this.seenMessages=new Set}handleIncomingMessage(e,t){if(!e.payload||!e.messageId){k.warn("Received a message without a payload or messageId, cannot process.",e);return}if(this.seenMessages.has(e.messageId))return;if(this.seenMessages.add(e.messageId),this.seenMessages.size>Ys){const s=this.seenMessages.values().next().value;this.seenMessages.delete(s)}e.noGossip||this.sendSyncMessage(e.payload,null,e.messageId);const n=e.payload;switch(n.type){case"peer_introduction":this.sync.handlePeerIntroduction(n);break;default:this.sync.fileSync&&this.sync.fileSync.handleSyncMessage(n);break}}sendSyncMessage(e,t=null,n=null){const s=n||crypto.randomUUID(),o=JSON.stringify({messageId:s,payload:e,noGossip:!!t});if(this.seenMessages.add(s),t){const r=this.sync.peerConnections.get(t);if(r&&r.dataChannel&&r.dataChannel.readyState==="open")try{r.dataChannel.send(o)}catch(c){console.error(`Error sending direct message to ${t.substring(0,8)}...:`,c)}}else this.sync.peerConnections.forEach((r,c)=>{if(r.dataChannel&&r.dataChannel.readyState==="open")try{r.dataChannel.send(o)}catch(l){console.error(`Error gossiping message to ${c.substring(0,8)}...:`,l)}})}destroy(){this.seenMessages.clear()}}class Zs{constructor(e){this.signaling=e}async connectToPeer(e){const t=this.signaling.sync,n=t.createPeerConnection(e,!0);if(n)try{const s=n.createDataChannel("syncChannel");t.setupDataChannel(e,s);const i=await n.createOffer();await n.setLocalDescription(i),this.signaling.sendSignal({type:"offer",sdp:i.sdp},e)}catch(s){k.error(`Failed to initiate connection to ${e}:`,s)}}}class Qs{constructor(e){this.sync=e,this.ws=null,this.signalingServerUrl=localStorage.getItem("thoughtform_signaling_server")||"wss://socket.thoughtform.garden",this.peerId=null,this._webSocketManager=new Vs(this),this._signalingMessageHandler=new Js(this),this._webrtcInitiator=new Zs(this),this._syncMessageRouter=new Xs(this)}updateSignalingServerUrl(e){this.signalingServerUrl=e,localStorage.setItem("thoughtform_signaling_server",e)}async joinSession(e,t){try{await this._webSocketManager.connectToSignalingServer(),this._webSocketManager.sendJoinSessionRequest(e,t)}catch{this.sync.updateConnectionState("error","Failed to connect to signaling server.")}}connectToPeer(e){e!==this.peerId&&this.peerId>e&&this._webrtcInitiator.connectToPeer(e)}sendSignal(e,t){this._webSocketManager.sendSignal(e,t)}async handleSignal(e,t){const n=this.sync;try{let s=n.peerConnections.get(e);if(!s)if(t.type==="offer"){if(s=n.createPeerConnection(e,!1),!s){console.warn(`[SYNC-SIGNAL] Received offer from ${e.substring(0,8)} but at connection limit. Ignoring.`);return}}else{k.warn(`[SYNC-SIGNAL] Received signal from unknown peer ${e.substring(0,8)} before an offer. Discarding.`);return}if(t.type==="offer"){await s.setRemoteDescription(new RTCSessionDescription(t));const i=await s.createAnswer();await s.setLocalDescription(i),this.sendSignal({type:"answer",sdp:i.sdp},e)}else t.type==="answer"?await s.setRemoteDescription(new RTCSessionDescription(t)):t.type==="candidate"&&await s.addIceCandidate(new RTCIceCandidate(t.candidate))}catch(s){k.error(`Error handling signal from ${e}:`,s)}}sendSyncMessage(e,t,n){this._syncMessageRouter.sendSyncMessage(e,t,n)}handleIncomingMessage(e,t){this._syncMessageRouter.handleIncomingMessage(e,t)}destroy(){this.ws&&(this.ws.close(),this.ws=null),this._syncMessageRouter.destroy()}}class ei{constructor(){this._listeners={}}addEventListener(e,t){e in this._listeners||(this._listeners[e]=[]),this._listeners[e].push(t)}removeEventListener(e,t){if(!(e in this._listeners))return;const n=this._listeners[e];for(let s=0,i=n.length;s<i;s++)if(n[s]===t){n.splice(s,1);return}}dispatchEvent(e){if(!(e.type in this._listeners))return!0;const t=this._listeners[e.type].slice();for(let n=0,s=t.length;n<s;n++)t[n].call(this,e);return!e.defaultPrevented}destroy(){this._listeners={}}}class ti{static getGitClient(e){if(e.gitClient)return e.gitClient;if(e.sync&&e.sync.gitClient)return e.sync.gitClient;if(window.thoughtform){for(const t in window.thoughtform)if(window.thoughtform[t]&&typeof window.thoughtform[t]=="object"){if(window.thoughtform[t].hasOwnProperty("readFile")&&window.thoughtform[t].hasOwnProperty("writeFile"))return k.log(`DEBUG: Found potential gitClient-like object at window.thoughtform.${t}`),window.thoughtform[t];if(window.thoughtform[t].gitClient)return k.log(`DEBUG: Found gitClient at window.thoughtform.${t}.gitClient`),window.thoughtform[t].gitClient}if(window.thoughtform.gitClient)return k.log("DEBUG: Found gitClient at window.thoughtform.gitClient"),window.thoughtform.gitClient;if(window.thoughtform.editor&&window.thoughtform.editor.gitClient)return k.log("DEBUG: Found gitClient at window.thoughtform.editor.gitClient"),window.thoughtform.editor.gitClient}return k.log("DEBUG: _getGitClient: No gitClient found in standard locations or window.thoughtform"),null}}class ni{static setupDataChannel(e,t){t.onopen=()=>{e.sync.isConnected=!0,e.sync.ui.showMessages(),e.sync.addMessage("File sync data channel is open."),k.log("DEBUG: SyncFiles confirmed data channel is open.")},t.onmessage=async n=>{try{const s=JSON.parse(n.data);await e.sync._handleIncomingSyncMessage(s,"P2P")}catch(s){console.error("Error parsing sync message from DataChannel:",s,"Raw data:",n.data)}},t.onclose=()=>{e.sync.isConnected=!1,e.sync.ui.hideMessages(),e.sync.addMessage("File sync data channel closed."),k.log("DEBUG: SyncFiles confirmed data channel is closed.")},t.onerror=n=>{const s=n.error;s&&s.name==="OperationError"&&s.message.includes("User-Initiated Abort")?k.log("Data channel closed intentionally by a peer.",n):(console.error("Data channel error:",n),e.sync.addMessage("Data channel error: "+(s?s.message:"Unknown error")))}}}class nt{static async _listAllFiles(e,t){const n=e.pfs;if(!n)throw new Error("gitClient does not have pfs property");let s=[];try{const i=await n.readdir(t);for(const o of i){if(o===".git")continue;const r=t==="/"?`/${o}`:`${t}/${o}`;try{(await n.stat(r)).isDirectory()?s=s.concat(await this._listAllFiles(e,r)):s.push(r)}catch(c){k.warn(`Could not stat ${r}, skipping.`,c)}}}catch(i){k.log(`Directory not readable: ${t}`,i)}return s}static async handleFileUpdate(e,t){e.incrementPendingWrites();try{if(!t.gardenName)throw new Error("Received file update without a gardenName during a full sync.");const n=new E(t.gardenName);if(t.isFullSync){e.deletedGitDirs.has(t.gardenName)||(e.deletedGitDirs.add(t.gardenName),e.dispatchEvent(new CustomEvent("syncProgress",{detail:{message:`Preparing to receive garden: ${t.gardenName}...`,type:"info"}})),await n.initRepo(),e.dispatchEvent(new CustomEvent("syncProgress",{detail:{message:`Replacing git history for ${t.gardenName}...`,type:"info"}})),await n.rmrf("/.git")),e.dispatchEvent(new CustomEvent("syncProgress",{detail:{message:`Writing: ${t.path.substring(1)} (${t.gardenName})`,type:"info"}}));const s=Buffer.from(t.content,"base64");await n.writeFile(t.path,s)}else{const s=t.isBase64?Buffer.from(t.content,"base64"):t.content;await n.writeFile(t.path,s),e.sync.addMessage(`Updated file: ${t.path} in garden ${t.gardenName}`)}}catch(n){console.error("Error handling file update for path:",t.path,n),e.dispatchEvent(new CustomEvent("syncProgress",{detail:{message:`Error updating file ${t.path}: ${n.message}`,type:"error"}}))}finally{e.decrementPendingWrites()}}}class st{static async handleSyncMessage(e,t){switch(t.type){case"send_initiation":this.handleSendInitiation(e,t);break;case"sync_cancel":this.handleSyncCancel(e,t);break;case"file_update":await nt.handleFileUpdate(e,t);break;case"request_gardens":await this.handleRequestGardens(e,t.gardens,t.requesterId);break;case"garden_zip_chunk":await this.handleGardenZipChunk(e,t);break;case"garden_zip_complete":await this.handleGardenZipComplete(e,t);break;case"full_sync_complete":e.dispatchEvent(new CustomEvent("syncProgress",{detail:{message:"File stream complete. Waiting for writes to finish...",type:"info"}})),e.markSyncStreamAsComplete();break;default:k.log("Unknown sync message type:",t.type)}}static handleSendInitiation(e,t){e.isSyncCancelled||(e.currentTransferId=t.transferId,e.dispatchEvent(new CustomEvent("syncProgress",{detail:{message:`Incoming transfer from peer for gardens: ${t.gardens.join(", ")}.`,type:"info"}})))}static handleSyncCancel(e,t){e.currentTransferId===t.transferId&&e.cancelSync(!1)}static async handleRequestGardens(e,t=[],n){if(!n){const s="Error: Received garden request without a requesterId. Cannot send response.";console.error(s),e.dispatchEvent(new CustomEvent("syncProgress",{detail:{message:s,type:"error"}}));return}e.dispatchEvent(new CustomEvent("syncProgress",{detail:{message:`Received request for gardens: ${t.join(", ")} from ${n.substring(0,8)}...`,type:"info"}})),await this.sendGardens(e,t,[n])}static async sendGardens(e,t,n){if(!t||t.length===0||!n||n.length===0)return;const s=crypto.randomUUID();e.currentTransferId=s,e.targetPeers=n,e.sync.sendSyncMessage({type:"send_initiation",gardens:t,transferId:s});const i=64*1024,o=10*1024*1024,r=c=>new Promise(l=>{if(c.bufferedAmount<o)l();else{const h=()=>{c.bufferedAmount<o&&(c.removeEventListener("bufferedamountlow",h),l())};c.addEventListener("bufferedamountlow",h)}});try{for(const c of t){if(e.isSyncCancelled)throw new Error("Sync cancelled by user.");e.dispatchEvent(new CustomEvent("syncProgress",{detail:{message:`Preparing ${c} for transfer...`,type:"info"}}));const l=new Y,h=new E(c),d=await this.getAllFilesIncludingGit(h.pfs,"/");e.dispatchEvent(new CustomEvent("syncProgress",{detail:{message:`Zipping ${d.length} files from ${c}...`,type:"info"}}));for(const p of d){if(e.isSyncCancelled)throw new Error("Sync cancelled by user.");const y=await h.pfs.readFile(p),w=p.startsWith("/")?p.substring(1):p;l.file(w,y)}if(e.isSyncCancelled)throw new Error("Sync cancelled by user.");const u=await l.generateAsync({type:"uint8array",compression:"DEFLATE",compressionOptions:{level:6}}),g=(u.length/1024/1024).toFixed(2);e.dispatchEvent(new CustomEvent("syncProgress",{detail:{message:`Zip created for ${c} (${g} MB).`,type:"info"}}));const f=Math.ceil(u.length/i);for(const p of n){if(e.isSyncCancelled)throw new Error("Sync cancelled by user.");const y=e.sync.peerConnections.get(p);if(!y||!y.dataChannel||y.dataChannel.readyState!=="open"){const m=`Error: Cannot send files to ${p.substring(0,8)}... No open data channel.`;console.error(m),e.dispatchEvent(new CustomEvent("syncProgress",{detail:{message:m,type:"error"}}));continue}const w=y.dataChannel;e.dispatchEvent(new CustomEvent("syncProgress",{detail:{message:`Sending ${c} to ${p.substring(0,8)}...`,type:"info"}}));for(let m=0;m<f;m++){if(e.isSyncCancelled)throw new Error("Sync cancelled by user.");await r(w);const b=m*i,C=Math.min(b+i,u.length),x=u.slice(b,C);e.sync.sendSyncMessage({type:"garden_zip_chunk",gardenName:c,transferId:s,chunkIndex:m,totalChunks:f,data:Buffer.from(x).toString("base64"),zipSize:u.length},p),((m+1)%10===0||m+1===f)&&e.dispatchEvent(new CustomEvent("syncProgress",{detail:{message:`Sent ${m+1} of ${f} chunks for ${c} to ${p.substring(0,8)}...`,type:"info"}}))}e.sync.sendSyncMessage({type:"garden_zip_complete",gardenName:c,transferId:s},p),e.dispatchEvent(new CustomEvent("syncProgress",{detail:{message:`Finished sending ${c} to ${p.substring(0,8)}.`,type:"info"}}))}}for(const c of n)e.sync.sendSyncMessage({type:"full_sync_complete"},c);e.dispatchEvent(new CustomEvent("syncProgress",{detail:{message:"All selected gardens sent successfully.",type:"complete",action:"send"}}))}catch(c){c.message.includes("cancelled")?e.dispatchEvent(new CustomEvent("syncProgress",{detail:{message:"Sync cancelled by user.",type:"cancelled"}})):(console.error("Error handling garden send/request:",c),e.dispatchEvent(new CustomEvent("syncProgress",{detail:{message:`Error: ${c.message}`,type:"error"}})))}}static async getAllFilesIncludingGit(e,t){let n=[];try{const s=await e.readdir(t);for(const i of s){const o=`${t==="/"?"":t}/${i}`;try{(await e.stat(o)).isDirectory()?n=n.concat(await this.getAllFilesIncludingGit(e,o)):n.push(o)}catch(r){k.warn(`Could not stat ${o}, skipping.`,r)}}}catch(s){k.log(`Directory not readable: ${t}`,s)}return n}static async handleGardenZipChunk(e,t){if(e.isSyncCancelled||e.currentTransferId!==t.transferId)return;e.activeTransfers||(e.activeTransfers=new Map);const n=`${t.gardenName}-${t.transferId}`;e.activeTransfers.has(n)||(e.activeTransfers.set(n,{chunks:new Array(t.totalChunks),receivedCount:0,totalChunks:t.totalChunks,gardenName:t.gardenName,zipSize:t.zipSize}),e.dispatchEvent(new CustomEvent("syncProgress",{detail:{message:`Receiving ${t.gardenName} (${(t.zipSize/1024/1024).toFixed(2)} MB)...`,type:"info"}})));const s=e.activeTransfers.get(n);s.chunks[t.chunkIndex]=Buffer.from(t.data,"base64"),s.receivedCount++,(s.receivedCount%10===0||s.receivedCount===s.totalChunks)&&e.dispatchEvent(new CustomEvent("syncProgress",{detail:{message:`Received ${s.receivedCount} of ${s.totalChunks} chunks for ${t.gardenName}...`,type:"info"}}))}static async handleGardenZipComplete(e,t){if(e.isSyncCancelled)return;const n=`${t.gardenName}-${t.transferId}`,s=e.activeTransfers.get(n);if(s){if(s.receivedCount!==s.totalChunks){e.dispatchEvent(new CustomEvent("syncProgress",{detail:{message:`Error: Missing chunks for ${t.gardenName}`,type:"error"}})),e.activeTransfers.delete(n);return}try{e.dispatchEvent(new CustomEvent("syncProgress",{detail:{message:`Reassembling and extracting ${t.gardenName}...`,type:"info"}}));const i=s.chunks.reduce((u,g)=>u+g.length,0),o=new Uint8Array(i);let r=0;for(const u of s.chunks)o.set(u,r),r+=u.length;const c=await Y.loadAsync(o),l=new E(t.gardenName);await l.initRepo(),e.dispatchEvent(new CustomEvent("syncProgress",{detail:{message:`Clearing existing data for ${t.gardenName}...`,type:"info"}})),await l.rmrf("/.git"),await l.clearWorkdir();const h=Object.entries(c.files);let d=0;for(const[u,g]of h)if(!g.dir){const f=await g.async("uint8array"),p=`/${u}`,y=p.substring(0,p.lastIndexOf("/"));y&&y!=="/"&&await l.ensureDir(y),await l.pfs.writeFile(p,f),d++}e.dispatchEvent(new CustomEvent("syncProgress",{detail:{message:`Successfully extracted ${t.gardenName} (${d} files).`,type:"complete"}})),e.activeTransfers.delete(n),e.activeTransfers.size===0&&e.markSyncStreamAsComplete()}catch(i){console.error(`Error extracting garden ${t.gardenName}:`,i),e.dispatchEvent(new CustomEvent("syncProgress",{detail:{message:`Error extracting ${t.gardenName}: ${i.message}`,type:"error"}})),e.activeTransfers.delete(n)}}}}class Ne{static async sendGardensToPeers(e,t){e.dispatchEvent(new CustomEvent("syncProgress",{detail:{message:"Initiating send process...",type:"info"}})),await st.sendGardens(e,t.gardens,t.peers)}static requestSpecificGardens(e,t){e.dispatchEvent(new CustomEvent("syncProgress",{detail:{message:"Requesting selected gardens from peers...",type:"info"}}));const n=e.sync.signaling.peerId;if(!n){const s="Cannot request gardens: own peer ID is not available.";e.dispatchEvent(new CustomEvent("syncProgress",{detail:{message:s,type:"error"}})),console.error(s);return}Object.entries(t).forEach(([s,i])=>{const o=s.substring(0,8);e.dispatchEvent(new CustomEvent("syncProgress",{detail:{message:`Sending request to peer ${o}... for gardens: ${i.join(", ")}`,type:"info"}})),e.sync.sendSyncMessage({type:"request_gardens",gardens:i,requesterId:n},s)}),e.sync.addMessage(`Sent requests for ${Object.keys(t).length} peer(s).`)}static sendFileUpdate(e,t,n,s){e.sync.sendSyncMessage({type:"file_update",path:t,content:n,timestamp:s})}}class si extends ei{constructor(e){super(),this.sync=e,this.gitClient=null,this.pendingWriteCount=0,this.isSyncCompleteMessageReceived=!1,this.deletedGitDirs=new Set,this.isSyncFailed=!1,this.isSyncCancelled=!1,this.activeTransfers=new Map,this.currentTransferId=null,this.targetPeers=[]}resetFullSyncState(){this.pendingWriteCount=0,this.isSyncCompleteMessageReceived=!1,this.deletedGitDirs.clear(),this.activeTransfers.clear(),this.isSyncFailed=!1,this.isSyncCancelled=!1,this.currentTransferId=null,this.targetPeers=[]}_getGitClient(){return ti.getGitClient(this)}setGitClient(e){this.gitClient=e}setupDataChannel(e){ni.setupDataChannel(this,e)}async handleSyncMessage(e){if(!(this.isSyncCancelled&&e.type!=="sync_cancel"))try{await st.handleSyncMessage(this,e)}catch(t){console.error("[SyncFiles] Critical error handling sync message:",t),this.isSyncFailed=!0,this.dispatchEvent(new CustomEvent("syncProgress",{detail:{message:`A critical error occurred: ${t.message}. Aborting sync.`,type:"error"}}))}}async sendGardensToPeers(e){this.resetFullSyncState(),await Ne.sendGardensToPeers(this,e)}requestSpecificGardens(e){this.resetFullSyncState(),Ne.requestSpecificGardens(this,e)}cancelSync(e=!0){this.isSyncCancelled||(this.isSyncCancelled=!0,this.activeTransfers.clear(),e&&this.currentTransferId&&this.sync.sendSyncMessage({type:"sync_cancel",transferId:this.currentTransferId}),this.dispatchEvent(new CustomEvent("syncProgress",{detail:{message:"Sync cancelled by user.",type:"cancelled"}})))}incrementPendingWrites(){this.pendingWriteCount++}decrementPendingWrites(){this.pendingWriteCount--,this.checkForReload()}markSyncStreamAsComplete(){this.isSyncCompleteMessageReceived=!0,this.checkForReload()}checkForReload(){this.isSyncFailed||this.isSyncCancelled||this.isSyncCompleteMessageReceived&&this.pendingWriteCount===0&&this.activeTransfers.size===0&&(this.dispatchEvent(new CustomEvent("syncProgress",{detail:{message:"All files received and written. Reloading...",type:"complete",action:"receive"}})),setTimeout(()=>window.location.reload(),1500))}destroy(){super.destroy(),this.activeTransfers.clear()}async getAllFiles(e){return nt._listAllFiles(e,"/")}}class ii{constructor(e){this.sync=e,this.syncMethodIndicatorEl=null,this.syncProgressModal=null,this.syncProgressLogArea=null,this.syncProgressFinalMessageArea=null,this.syncProgressActionButton=null,this.connectBtn=null,this.nameInput=null,this.peerPrefixInput=null,this.autoConnectCheckbox=null}render(){this.sync._container&&(this.sync._container.innerHTML=`
  ...
  `}class hi{constructor(e){this.eruda=e,this._$el=null}add(){this.eruda.add({name:"Data",init:e=>{this._$el=e,this._render(),this._bindEvents()},show:()=>this._$el.show(),hide:()=>this._$el.hide()})}_render(){this._$el.html(`
      <div>
    ...
    `)}_bindEvents(){const e=this._$el;e.find("#export-btn")[0].addEventListener("click",()=>this._handleExport()),e.find("#import-btn")[0].addEventListener("click",()=>e.find("#import-file-input")[0].click()),e.find("#import-file-input")[0].addEventListener("change",t=>this._handleFileSelect(t)),e.find("#clear-data-btn")[0].addEventListener("click",()=>this._handleClearData()),e.find("#reset-settings-btn")[0].addEventListener("click",()=>this._handleResetSettings())}async _handleResetSettings(){if(!await S.confirm({title:"Reset Default Settings?",message:"This will overwrite the default configuration and hook files in your 'Settings' garden with the latest versions from the application. <br><br><strong>Your custom scripts and other files will not be affected.</strong>",okText:"Reset Files"}))return;const t=new S({title:"Restoring Settings..."});let n="";const s=i=>{console.log(`[Settings Reset] ${i}`),n+=`<div>${i}</div>`,t.updateContent(`<div style="font-family: monospace; max-height: 300px; overflow-y: auto;">${n}</div>`)};t.show(),await di(s)}_handleExport(){const e=localStorage.getItem("thoughtform_gardens"),t=e?JSON.parse(e):["home"],n=new S({title:"Select Gardens to Export"});n.updateContent(ce("Choose which gardens to include in the export:",t));const s=n.content;s.querySelector(".select-all-btn").onclick=()=>s.querySelectorAll(".garden-select-checkbox").forEach(o=>o.checked=!0),s.querySelector(".select-none-btn").onclick=()=>s.querySelectorAll(".garden-select-checkbox").forEach(o=>o.checked=!1);const i=async()=>{const o=Array.from(s.querySelectorAll(".garden-select-checkbox:checked")).map(h=>h.value);n.destroy();const r=new S({title:"Exporting Gardens..."});r.updateContent("<p>Preparing export. Please wait...</p>");let c=!1,l="";r.addFooterButton("Cancel",()=>{c=!0,r.destroy()}),r.show();try{await ri(o,h=>{if(c)throw new Error("Export cancelled by user.");l+=h+"<br>",r.updateContent(`<div style="font-family: monospace; max-height: 300px; overflow-y: auto;">${l}</div>`)}),c||(r.clearFooter(),r.updateContent("<p>Export complete! The download will begin shortly.</p>"),setTimeout(()=>r.destroy(),3e3))}catch(h){c||(r.clearFooter(),r.updateContent(`<p style="color: #F44747;"><strong>Export Failed</strong><br>${h.message}</p>`),r.addFooterButton("Close",()=>r.destroy()))}};n.addFooterButton("Export Selected",i),n.addFooterButton("Cancel",()=>n.destroy()),n.show()}async _handleFileSelect(e){const t=e.target,n=t.files[0];if(!n)return;const s=new S({title:"Select Gardens to Import"});s.updateContent("Scanning zip file..."),s.show();try{const i=await ai(n);if(i.length===0){s.updateContent("No valid gardens found in this zip file."),s.addFooterButton("Close",()=>s.destroy());return}s.updateContent(ce(`Found ${i.length} garden(s). Select which to import:`,i));const o=s.content;o.querySelector(".select-all-btn").onclick=()=>o.querySelectorAll(".garden-select-checkbox").forEach(c=>c.checked=!0),o.querySelector(".select-none-btn").onclick=()=>o.querySelectorAll(".garden-select-checkbox").forEach(c=>c.checked=!1);const r=async()=>{const c=Array.from(o.querySelectorAll(".garden-select-checkbox:checked")).map(h=>h.value);s.clearFooter(),s.updateContent("Starting import...");let l="";try{await ci(n,c,h=>{l+=`${h}<br>`,s.updateContent(l)})}catch(h){s.updateContent(`<strong>Error during import:</strong><br>${h.message}`),s.addFooterButton("Close",()=>s.destroy())}};s.addFooterButton("Import Selected",r),s.addFooterButton("Cancel",()=>s.destroy())}catch(i){s.updateContent(`<strong>Error:</strong> Could not read the zip file.<br>${i.message}`),s.addFooterButton("Close",()=>s.destroy())}finally{t.value=""}}_handleClearData(){const e=localStorage.getItem("thoughtform_gardens"),t=e?JSON.parse(e):[],n=new S({title:"Clear Garden Data"});n.updateContent(ce("Select gardens to permanently delete:",t,!1));const s=n.content;s.querySelector(".select-all-btn").onclick=()=>s.querySelectorAll(".garden-select-checkbox").forEach(r=>r.checked=!0),s.querySelector(".select-none-btn").onclick=()=>s.querySelectorAll(".garden-select-checkbox").forEach(r=>r.checked=!1);const i=async()=>{const r=Array.from(s.querySelectorAll(".garden-select-checkbox:checked")).map(l=>l.value);n.clearFooter(),n.updateContent("Starting deletion...");let c="";try{await li(r,l=>{c+=`${l}<br>`,n.updateContent(c)})}catch(l){n.updateContent(`<strong>Error during deletion:</strong><br>${l.message}`),n.addFooterButton("Close",()=>n.destroy()).classList.add("destructive")}};n.addFooterButton("Delete Selected",i).classList.add("destructive"),n.addFooterButton("Cancel",()=>n.destroy()),n.show()}}function ui(a){new hi(a).add()}function gi(a,e){let t;return function(...s){const i=()=>{clearTimeout(t),a(...s)};clearTimeout(t),t=setTimeout(i,e)}}class fi{constructor(e){this.eruda=e,this._$el=null,this.debouncedSave=gi(()=>this._handleSaveConfig(),300)}add(){this.eruda.add({name:"AI",init:e=>{this._$el=e,this._render(),this._bindEvents()},show:()=>{this._$el.show(),this._loadAndRenderProviders()},hide:()=>this._$el.hide()})}_render(){this._$el.html(`
    ...
    `)}_loadAndRenderProviders(){let e=JSON.parse(localStorage.getItem("thoughtform_ai_providers_list")||"[]");const t=localStorage.getItem("thoughtform_ai_provider")||"gemini";e.length===0&&e.push({id:"custom",endpoint:"http://localhost:11434/v1",model:"",apiKey:""});const n=this._$el.find("#custom-providers-list")[0],s=this._$el.find("#ai-active-provider")[0];n.innerHTML="",s.innerHTML='<option value="gemini">Google Gemini</option>',e.forEach(i=>{const o=this._createProviderElement(i);n.appendChild(o);const r=document.createElement("option");r.value=i.id,r.textContent=i.id,s.appendChild(r)}),s.value=t}_createProviderElement(e){const t=document.createElement("div");return t.className="sync-panel provider-instance",t.dataset.providerId=e.id,t.innerHTML=`
...
Classification:`;return(await t.getCompletionAsString(s,null,n)).trim()}async _compressScratchpad(e,t,n,s,i){i("Cognitive compression initiated...");const o=`From the following error message, extract only the integer value for the token limit. If you cannot find one, respond with '8000'. Error: "${t}"`;i("Analyzing context limit...");const r=await n.getCompletionAsString(o,null,s),c=parseInt(r,10)||8e3;i(`Context limit detected: ~${c.toLocaleString()} tokens.`);const l=c*.5,h="---",d=e.indexOf(h,e.indexOf("INITIAL CONTEXT"));if(d===-1)throw new Error("Compression failed: Could not find end of initial context.");const u=e.substring(0,d+h.length);let g=e.substring(d+h.length);const f="[COMPRESSED MEMORY]:";let p="";const y=g.indexOf(f);if(y!==-1){const N=g.indexOf(`
---`,y);p=g.substring(y,N),g=g.substring(N)}if(g.trim().length===0)throw new Error("Compression failed: No uncompressed history to process.");let w="",m="";const b=g.split("---").filter(N=>N.trim());let C=0,x=0;for(const N of b){const U=X(N);C+U<l?(w+=N+"---",C+=U,x++):m+=N+"---"}x===0&&b.length>0&&(i("Warning: A single memory item is larger than the safe summarization budget. Truncating."),w=b[0].substring(0,l*4),m=b.slice(1).join("---"));const T=`# Persona: You are a Memory Compression Module.
...
${f} ${_}
---${m}`}async _orchestrate(e,t,n){await this._initialize(),this._sendStreamEvent(t,"status",`Starting with goal: "${e}"`);let s=`USER GOAL: ${e}
---
INITIAL CONTEXT:
${this.initialContext}
---`,i=0,o=!1,r=0,c=0;const l=new Set,h=({input:y,output:w})=>{r+=y,c+=w},d={getCompletion:(y,w,m)=>this.aiService.getCompletion(y,b=>{h(b),w&&w(b)},m||n),getCompletionAsString:(y,w,m)=>this.aiService.getCompletionAsString(y,b=>{h(b),w&&w(b)},m||n)},u={Traversal:Si,Git:E};for(;!o;){if(i++,n.aborted)throw new DOMException("Agent run was cancelled by the user.","AbortError");const y=Array.from(this.tools.values()).map(L=>`- ${L.name}: ${L.description}`).join(`
`),w=this._fillPrompt(Ke,{scratchpad:s,tool_list:y}),m={input:r,output:c};let b;try{b=(await this._getJsonCompletion(w,d,n)).responseJson}catch(L){if(L.name==="AbortError")throw L;const W=L.message;this._sendStreamEvent(t,"status","An error occurred during planning. Analyzing...");const Se=await this._classifyError(W,d,n);switch(this._sendStreamEvent(t,"status",`Error classified as: ${Se}`),Se){case"CONTEXT_OVERFLOW":s+=`
OBSERVATION: CRITICAL API FAILURE. The context window is full. You must compress your memory to continue. Error Details: "${W}"
---`;continue;case"RATE_LIMIT":this._sendStreamEvent(t,"status","API rate limit reached. Waiting 5 seconds before retry..."),await new Promise(ct=>setTimeout(ct,5e3));continue;case"INVALID_JSON":s+=`
...
---`;continue}}const C=r-m.input,x=c-m.output;this._sendStreamEvent(t,"status",`Step ${i}: Planning...
[Step: ${C.toLocaleString()} in / ${x.toLocaleString()} out]
...
ASSESSMENT: The goal is met. I will now synthesize the final answer.`;continue}const _=I.tool,N=I.args||{};this._sendStreamEvent(t,"action",`Using tool \`${_}\` with args: ${JSON.stringify(N)}`);const U=this.tools.get(_),G={git:this.gitClient,ai:d,dependencies:u,onProgress:L=>this._sendStreamEvent(t,"status",L),signal:n,addSource:L=>{L&&typeof L=="string"&&l.add(L)}},Z={input:r,output:c};let O=await U.execute(N,G);if(_==="requestMemoryCompression")try{const L=JSON.parse(O);if(L.action==="request_memory_compression"){s=await this._compressScratchpad(s,L.details.errorMessage,d,n,W=>this._sendStreamEvent(t,"status",W));continue}}catch{}const B=String(O),Q=X(B),ie=Q>250?`[Observation received (${Q.toLocaleString()} tokens) and added to context.]`:B;this._sendStreamEvent(t,"observation",ie);const oe=r-Z.input,V=c-Z.output;(oe>0||V>0)&&this._sendStreamEvent(t,"status",`Tool LLM Usage:
[Step: ${oe.toLocaleString()} in / ${V.toLocaleString()} out]
[Total: ${r.toLocaleString()} in / ${c.toLocaleString()} out]`),s+=`
ACTION: Called tool '${_}' with args: ${JSON.stringify(N)}
OBSERVATION: ${B}
---`}this._sendStreamEvent(t,"status","Agent has finished its work. Synthesizing final answer...");const g=this._fillPrompt(Ve,{goal:e,context_buffer:s}),p=(await d.getCompletion(g)).getReader();for(;;){const{done:y,value:w}=await p.read();if(y)break;t.enqueue(w)}l.size>0&&t.enqueue(`
<!-- Sources: ${Array.from(l).join(", ")} -->`),t.enqueue(`
<!-- Total Tokens: ${r.toLocaleString()} in / ${c.toLocaleString()} out -->`),t.close()}}class Ii{constructor(){this.config={activeProvider:"gemini",geminiApiKey:"",geminiModelName:"gemini-2.5-flash",providers:[]},this.activeAgentControllers=new Map,this.loadConfig()}loadConfig(){this.config.activeProvider=localStorage.getItem("thoughtform_ai_provider")||"gemini",this.config.geminiApiKey=localStorage.getItem("thoughtform_gemini_api_key")||"",this.config.geminiModelName=localStorage.getItem("thoughtform_gemini_model_name")||"gemini-2.5-flash",this.config.providers=JSON.parse(localStorage.getItem("thoughtform_ai_providers_list")||"[]")}async getCompletion(e,t,n){let s,i=this.config.activeProvider;if(this.config.override_activeProvider&&(i=this.config.override_activeProvider),i==="gemini"){if(!this.config.geminiApiKey)throw new Error("Active provider is Gemini, but the API key is not set. Add it in DevTools > AI.");s=bi(this.config.geminiApiKey,this.config.geminiModelName,e,n)}else{const h=this.config.providers.find(f=>f.id===i);if(!h)throw new Error(`AI provider "${i}" not found. Please configure it in DevTools > AI.`);const d=this.config.override_customModelName||h.model,u=this.config.override_customEndpointUrl||h.endpoint||"http://localhost:11434/v1",g=this.config.override_customApiKey||h.apiKey;if(!d)throw new Error(`Provider "${i}" has no Model Name configured. This is a required field.`);s=Ci(u,g,d,e,n)}const o=await s;if(!t)return o;const r=X(e);let c="";const l=new TransformStream({transform(h,d){c+=h,d.enqueue(h)},flush(h){const d=X(c);t({input:r,output:d})}});return o.pipeThrough(l)}async getCompletionAsString(e,t,n){const i=(await this.getCompletion(e,t,n)).getReader();let o="";for(;;){const{done:r,value:c}=await i.read();if(r)break;o+=c}return o}async handleAiChatRequest(e){let t=-1;const n="🤖 Thinking...";let s=null,i=-1,o=-1;try{const r=window.thoughtform.workspace.getActiveEditor();if(!r||!r.gitClient||!r.paneId)throw new Error("Cannot find active editor, gitClient, or paneId for agent.");if(s=r.paneId,this.activeAgentControllers.has(s))return;const c=new AbortController;this.activeAgentControllers.set(s,c);const l=e.state.selection.main.head,h=e.state.doc.lineAt(l);let d=h.number;for(;d>1&&e.state.doc.line(d-1).text.trim().startsWith(">$");)d--;let u=h.number;for(;u<e.state.doc.lines&&e.state.doc.line(u+1).text.trim().startsWith(">$");)u++;const g=e.state.doc.line(d).from,f=e.state.doc.line(u).to;let p=e.state.sliceDoc(g,f);p=p.split(`
`).map(G=>G.trim().replace(/^>\$\s*/,"")).join(`
`);const y=f,w={changes:{from:y,insert:`
${n}`}};e.dispatch(w),t=y+1;const m=e.state.doc.toString().replace(/<!-- Total Tokens:.*?-->/gs,"").trim();let b=this;if(r.aiOverrides&&Object.keys(r.aiOverrides).length>0){console.log("[AI Service] Applying session-specific AI overrides:",r.aiOverrides);const G={...this.config,override_activeProvider:r.aiOverrides.activeProvider,override_customModelName:r.aiOverrides.customModelName,override_customEndpointUrl:r.aiOverrides.customEndpointUrl,override_customApiKey:r.aiOverrides.customApiKey};b={...this,config:G}}const T=new Ti({gitClient:r.gitClient,aiService:b,initialContext:m}).run(p,c.signal).getReader(),I=`
<response>
`;e.dispatch({changes:{from:t,to:t+n.length,insert:I}});let _=!1;i=t+I.length,o=i;const N=/^\[(STATUS|THOUGHT|ACTION|OBSERVATION)\]\s(.*)/s;for(;;){const{done:G,value:Z}=await T.read();if(G)break;const O=Z,B=O.match(N);if(B){if(_)continue;const Q=B[1],ie=B[2].trim(),V=`${{STATUS:"> Status:",THOUGHT:"## Thought",ACTION:"## Action",OBSERVATION:"## Observation"}[Q]}
${ie}

`;e.dispatch({changes:{from:o,insert:V}}),o+=V.length}else _?(e.dispatch({changes:{from:o,insert:O}}),o+=O.length):(_=!0,e.dispatch({changes:{from:i,to:o,insert:O}}),o=i+O.length)}const U=`
</response>
